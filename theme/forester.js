(() => {
  var ht = window,
    ct =
      ht.ShadowRoot &&
      (ht.ShadyCSS === void 0 || ht.ShadyCSS.nativeShadow) &&
    ...
    xa = (r) => new He(typeof r == 'string' ? r : r + '', void 0, or),
    j0 = (r, ...e) => {
      let t =
        r.length === 1
          ? r[0]
      ...
      ct
        ...
        : e.forEach((t) => {
            let a = document.createElement('style'),
              n = ht.litNonce;
            n !== void 0 && a.setAttribute('nonce', n),
  ...
  var hr,
    ...
    Sa = (r, e) => e !== r && (e == e || r == r),
    cr = { attribute: !0, type: String, converter: dr, reflect: !1, hasChanged: Sa },
    mr = 'finalized',
    F0 = class extends HTMLElement {
      constructor() {
        super(),
          (this._$Ei = new Map()),
      ...
      static createProperty(e, t = cr) {
        if (
          ...
          let a = typeof e == 'symbol' ? Symbol() : '__' + e,
            n = this.getPropertyDescriptor(e, a, t);
      ...
      static getPropertyDescriptor(e, t, a) {
        return {
          ...
          set(n) {
            let i = this[e];
            (this[t] = n), this.requestUpdate(e, i, a);
          },
          configurable: !0,
          enumerable: !0,
        };
      ...
      static finalize() {
        if (this.hasOwnProperty(mr)) return !1;
        this[mr] = !0;
        ...
        if (
          ...
          for (let n of a) this.createProperty(n, t[n]);
        }
      ...
      addController(e) {
        ...
        ((t = this._$ES) !== null && t !== void 0 ? t : (this._$ES = [])).push(e),
          this.renderRoot !== void 0 &&
            this.isConnected &&
            ((a = e.hostConnected) === null || a === void 0 || a.call(e));
      }
      removeController(e) {
        var t;
        (t = this._$ES) === null ||
      ...
      connectedCallback() {
        ...
        this.renderRoot === void 0 && (this.renderRoot = this.createRenderRoot()),
          ...
          (e = this._$ES) === null ||
            ...
            e.forEach((t) => {
              var a;
              return (a = t.hostConnected) === null || a === void 0
                ? void 0
                : a.call(t);
            });
      }
      ...
      disconnectedCallback() {
        ...
        (e = this._$ES) === null ||
          ...
          e.forEach((t) => {
            var a;
            return (a = t.hostDisconnected) === null || a === void 0
              ? void 0
              : a.call(t);
          });
      }
      ...
      _$EO(e, t, a = cr) {
        ...
        if (i !== void 0 && a.reflect === !0) {
          let l = (
            ((n = a.converter) === null || n === void 0 ? void 0 : n.toAttribute) !==
            void 0
              ? a.converter
              : dr
          ).toAttribute(t, a.type);
          (this._$El = e),
            l == null ? this.removeAttribute(i) : this.setAttribute(i, l),
            (this._$El = null);
        }
      }
      _$AK(e, t) {
        ...
        if (i !== void 0 && this._$El !== i) {
          let l = n.getPropertyOptions(i),
            u =
              typeof l.converter == 'function'
                ? { fromAttribute: l.converter }
                : ((a = l.converter) === null || a === void 0
                      ? void 0
                      : a.fromAttribute) !== void 0
                  ? l.converter
                  : dr;
          (this._$El = i),
            (this[i] = u.fromAttribute(t, l.type)),
            (this._$El = null);
        }
      }
      requestUpdate(e, t, a) {
        let n = !0;
        e !== void 0 &&
          (((a = a || this.constructor.getPropertyOptions(e)).hasChanged || Sa)(
            this[e],
            t
          )
      ...
      update(e) {
        this._$EC !== void 0 &&
          (this._$EC.forEach((t, a) => this._$EO(a, this[a], t)),
          (this._$EC = void 0)),
          this._$Ek();
      }
      updated(e) {}
  ...
  (F0[mr] = !0),
    (F0.elementProperties = new Map()),
    (F0.elementStyles = []),
    (F0.shadowRootOptions = { mode: 'open' }),
    ka?.({ ReactiveElement: F0 }),
    ((hr = mt.reactiveElementVersions) !== null && hr !== void 0
      ? hr
  ...
  var fr,
    ft = window,
    Ce = ft.trustedTypes,
    Aa = Ce ? Ce.createPolicy('lit-html', { createHTML: (r) => r }) : void 0,
    pt = '$lit$',
    U0 = `lit$${(Math.random() + '').slice(9)}$`,
    vr = '?' + U0,
    Pi = `<${vr}>`,
    me = document,
    Pe = () => me.createComment(''),
    Le = (r) => r === null || (typeof r != 'object' && typeof r != 'function'),
    Da = Array.isArray,
    $a = (r) => Da(r) || typeof r?.[Symbol.iterator] == 'function',
    pr = `[
\f\r]`,
...
\f\r"'\`<>=]|("|')|))|$)`,
    ...
    za = /'/g,
    Ca = /"/g,
    Na = /^(?:script|style|textarea|title)$/i,
    Oa =
      (r) =>
      (e, ...t) => ({ _$litType$: r, strings: e, values: t }),
    r0 = Oa(1),
    ll = Oa(2),
    o0 = Symbol.for('lit-noChange'),
    G = Symbol.for('lit-nothing'),
    Ea = new WeakMap(),
    de = me.createTreeWalker(me, 129, null, !1);
  function Ra(r, e) {
  ...
  var _a = (r, e) => {
      ...
      for (let u = 0; u < t; u++) {
        let h = r[u],
          ...
          g = -1,
          b = 0;
        for (; b < h.length && ((l.lastIndex = b), (v = l.exec(h)), v !== null); )
          (b = l.lastIndex),
            l === Ie
              ? v[1] === '!--'
                ? (l = Ma)
                : v[1] !== void 0
                  ? (l = Ta)
                  : v[2] !== void 0
                    ? (Na.test(v[2]) && (n = RegExp('</' + v[2], 'g')), (l = ce))
                    : v[3] !== void 0 && (l = ce)
              : l === ce
                ? v[0] === '>'
                  ? ((l = n ?? Ie), (g = -1))
                  : v[1] === void 0
                    ? (g = -2)
                    : ((g = l.lastIndex - v[2].length),
                      (m = v[1]),
                      (l = v[3] === void 0 ? ce : v[3] === '"' ? Ca : za))
                : l === Ca || l === za
                  ? (l = ce)
                  : l === Ma || l === Ta
                    ? (l = Ie)
                    : ((l = ce), (n = void 0));
        let x = l === ce && r[u + 1].startsWith('/>') ? ' ' : '';
        i +=
          l === Ie
            ? h + Pi
            : g >= 0
              ? (a.push(m), h.slice(0, g) + pt + h.slice(g) + U0 + x)
              : h + U0 + (g === -2 ? (a.push(void 0), u) : x);
      }
      return [Ra(r, i + (r[t] || '<?>') + (e === 2 ? '</svg>' : '')), a];
    },
    je = class r {
      constructor({ strings: e, _$litType$: t }, a) {
        ...
        let i = 0,
          ...
          [m, v] = _a(e, t);
        if (
          ((this.el = r.createElement(m, a)),
          (de.currentNode = this.el.content),
          t === 2)
        ) {
          let g = this.el.content,
            b = g.firstChild;
          b.remove(), g.append(...b.childNodes);
        }
        for (; (n = de.nextNode()) !== null && h.length < u; ) {
          if (n.nodeType === 1) {
            if (n.hasAttributes()) {
              let g = [];
              for (let b of n.getAttributeNames())
                if (b.endsWith(pt) || b.startsWith(U0)) {
                  let x = v[l++];
                  if ((g.push(b), x !== void 0)) {
                    let k = n.getAttribute(x.toLowerCase() + pt).split(U0),
                      A = /([.?@])?(.*)/.exec(x);
                    h.push({
                      type: 1,
                      index: i,
              ...
              for (let b of g) n.removeAttribute(b);
            }
            if (Na.test(n.tagName)) {
              let g = n.textContent.split(U0),
                b = g.length - 1;
              if (b > 0) {
                ...
                for (let x = 0; x < b; x++)
                  n.append(g[x], Pe()),
                    de.nextNode(),
                    h.push({ type: 2, index: ++i });
                n.append(g[b], Pe());
              }
            }
          } else if (n.nodeType === 8)
            if (n.data === vr) h.push({ type: 2, index: i });
            else {
              let g = -1;
              for (; (g = n.data.indexOf(U0, g + 1)) !== -1; )
                h.push({ type: 7, index: i }), (g += U0.length - 1);
            }
          i++;
        }
      }
      static createElement(e, t) {
        let a = me.createElement('template');
        return (a.innerHTML = e), a;
      }
    };
  function fe(r, e, t = r, a) {
    var n, i, l, u;
    if (e === o0) return e;
    let h =
        a !== void 0
          ? (n = t._$Co) === null || n === void 0
            ? void 0
            : n[a]
          : t._$Cl,
      m = Le(e) ? void 0 : e._$litDirective$;
    return (
      h?.constructor !== m &&
        ((i = h?._$AO) === null || i === void 0 || i.call(h, !1),
        m === void 0 ? (h = void 0) : ((h = new m(r)), h._$AT(r, t, a)),
        a !== void 0
          ? (((l = (u = t)._$Co) !== null && l !== void 0 ? l : (u._$Co = []))[a] =
              h)
          : (t._$Cl = h)),
      h !== void 0 && (e = fe(r, h._$AS(r, e.values), h, a)),
      e
    );
  }
  var vt = class {
      ...
      u(e) {
        ...
        let {
          ...
          i = ((t = e?.creationScope) !== null && t !== void 0 ? t : me).importNode(
            a,
            !0
          );
        de.currentNode = i;
        ...
        for (; m !== void 0; ) {
          if (u === m.index) {
            let v;
            m.type === 2
              ? (v = new Ee(l, l.nextSibling, this, e))
              : m.type === 1
                ? (v = new m.ctor(l, m.name, m.strings, this, e))
                : m.type === 6 && (v = new xt(l, this, e)),
              this._$AV.push(v),
              (m = n[++h]);
          }
          u !== m?.index && ((l = de.nextNode()), u++);
        }
        return (de.currentNode = me), i;
      }
      v(e) {
        let t = 0;
        for (let a of this._$AV)
          a !== void 0 &&
            (a.strings !== void 0
    ...
    Ee = class r {
      ...
      get _$AU() {
        var e, t;
        return (t = (e = this._$AM) === null || e === void 0 ? void 0 : e._$AU) !==
          null && t !== void 0
          ? t
          : this._$Cp;
      }
      ...
      _(e) {
        this._$AH !== G && Le(this._$AH)
          ? (this._$AA.nextSibling.data = e)
          : this.$(me.createTextNode(e)),
          (this._$AH = e);
      }
      g(e) {
        var t;
        let { values: a, _$litType$: n } = e,
          i =
            typeof n == 'number'
              ? this._$AC(e)
              : (n.el === void 0 &&
                  (n.el = je.createElement(Ra(n.h, n.h[0]), this.options)),
                n);
        if (((t = this._$AH) === null || t === void 0 ? void 0 : t._$AD) === i)
          ...
          let l = new vt(i, this),
            u = l.u(this.options);
          l.v(a), this.$(u), (this._$AH = l);
        }
      }
      _$AC(e) {
        let t = Ea.get(e.strings);
        return t === void 0 && Ea.set(e.strings, (t = new je(e))), t;
      }
      T(e) {
        ...
        for (let i of e)
          n === t.length
            ? t.push((a = new r(this.k(Pe()), this.k(Pe()), this, this.options)))
            : (a = t[n]),
            a._$AI(i),
            n++;
      ...
      _$AR(e = this._$AA.nextSibling, t) {
        var a;
        for (
          (a = this._$AP) === null || a === void 0 || a.call(this, !1, !0, t);
          e && e !== this._$AB;
    ...
    pe = class {
      ...
      _$AI(e, t = this, a, n) {
        ...
        if (i === void 0)
          (e = fe(this, e, t, 0)),
            (l = !Le(e) || (e !== this._$AH && e !== o0)),
            l && (this._$AH = e);
        else {
          let u = e,
            h,
            m;
          for (e = i[0], h = 0; h < i.length - 1; h++)
            (m = fe(this, u[a + h], t, h)),
              m === o0 && (m = this._$AH[h]),
              l || (l = !Le(m) || m !== this._$AH[h]),
              m === G ? (e = G) : e !== G && (e += (m ?? '') + i[h + 1]),
              (this._$AH[h] = m);
        }
        l && !n && this.j(e);
      }
    ...
    yt = class extends pe {
      ...
      j(e) {
        e && e !== G
          ? this.element.setAttribute(this.name, Li)
          : this.element.removeAttribute(this.name);
      }
    },
    bt = class extends pe {
      ...
      _$AI(e, t = this) {
        var a;
        if ((e = (a = fe(this, e, t, 0)) !== null && a !== void 0 ? a : G) === o0)
          return;
        let n = this._$AH,
          i =
            (e === G && n !== G) ||
      ...
      handleEvent(e) {
        ...
        typeof this._$AH == 'function'
          ? this._$AH.call(
              (a = (t = this.options) === null || t === void 0 ? void 0 : t.host) !==
                null && a !== void 0
                ? a
                : this.element,
              e
    ...
    Ba = ft.litHtmlPolyfillSupport;
  Ba?.(je, Ee),
    ((fr = ft.litHtmlVersions) !== null && fr !== void 0
      ? fr
      : (ft.litHtmlVersions = [])
    ).push('2.8.0');
  var Ha = (r, e, t) => {
    var a, n;
    let i = (a = t?.renderBefore) !== null && a !== void 0 ? a : e,
      l = i._$litPart$;
    if (l === void 0) {
      let u = (n = t?.renderBefore) !== null && n !== void 0 ? n : null;
      i._$litPart$ = l = new Ee(e.insertBefore(Pe(), u), u, void 0, t ?? {});
    }
    return l._$AI(r), l;
  };
  var gr, yr;
  var g0 = class extends F0 {
    constructor() {
      super(...arguments),
    ...
    update(e) {
      ...
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
        super.update(e),
        (this._$Do = Ha(t, this.renderRoot, this.renderOptions));
    }
    connectedCallback() {
      var e;
  ...
  (g0.finalized = !0),
    (g0._$litElement$ = !0),
    (gr = globalThis.litElementHydrateSupport) === null ||
      gr === void 0 ||
      gr.call(globalThis, { LitElement: g0 });
  var Ia = globalThis.litElementPolyfillSupport;
  Ia?.({ LitElement: g0 });
  ((yr = globalThis.litElementVersions) !== null && yr !== void 0
    ? yr
    : (globalThis.litElementVersions = [])
  ).push('3.3.3');
  var ae = (r) => (e) =>
    typeof e == 'function'
      ? ((t, a) => (customElements.define(t, a), a))(r, e)
      : ((t, a) => {
          let { kind: n, elements: i } = a;
          return {
            kind: n,
            elements: i,
            finisher(l) {
  ...
  function W(r) {
    return (e, t) => (t !== void 0 ? Fi(r, e, t) : ji(r, e));
  }
  function V0(r) {
    return W({ ...r, state: !0 });
  }
  var br,
    $l =
      ((br = window.HTMLSlotElement) === null || br === void 0
        ? void 0
        : br.prototype.assignedElements) != null
        ? (r, e) => r.assignedElements(e)
        : (r, e) =>
            r.assignedNodes(e).filter((t) => t.nodeType === Node.ELEMENT_NODE);
  var c0 = {
      ATTRIBUTE: 1,
      CHILD: 2,
      PROPERTY: 3,
  ...
  var { I: Ui } = qa;
  var wt = (r) => r.strings === void 0,
    Pa = () => document.createComment(''),
    Be = (r, e, t) => {
      var a;
      let n = r._$AA.parentNode,
        i = e === void 0 ? r._$AB : e._$AA;
      if (t === void 0) {
        let l = n.insertBefore(Pa(), i),
          u = n.insertBefore(Pa(), i);
        t = new Ui(l, u, r, r.options);
      } else {
        let l = t._$AB.nextSibling,
          u = t._$AM,
          h = u !== r;
        if (h) {
          let m;
          (a = t._$AQ) === null || a === void 0 || a.call(t, r),
            (t._$AM = r),
            t._$AP !== void 0 && (m = r._$AU) !== u._$AU && t._$AP(m);
        }
        if (l !== i || h) {
          let m = t._$AA;
          for (; m !== l; ) {
            let v = m.nextSibling;
            n.insertBefore(m, i), (m = v);
          }
        }
      }
      return t;
    },
    ne = (r, e, t = r) => (r._$AI(e, t), r),
    Vi = {},
    kt = (r, e = Vi) => (r._$AH = e),
    La = (r) => r._$AH,
    St = (r) => {
      var e;
      (e = r._$AP) === null || e === void 0 || e.call(r, !1, !0);
      let t = r._$AA,
        a = r._$AB.nextSibling;
      for (; t !== a; ) {
        let n = t.nextSibling;
        t.remove(), (t = n);
      }
  ...
  var ja = (r, e, t) => {
      let a = new Map();
      for (let n = e; n <= t; n++) a.set(r[n], n);
      return a;
    },
    Fa = D0(
      class extends S0 {
        constructor(r) {
          if ((super(r), r.type !== c0.CHILD))
        ...
        ct(r, e, t) {
          ...
          let n = [],
            i = [],
            l = 0;
          for (let u of r) (n[l] = a ? a(u, l) : l), (i[l] = t(u, l)), l++;
          return { values: i, keys: n };
        }
        render(r, e, t) {
          return this.ct(r, e, t).values;
        }
        update(r, [e, t, a]) {
          var n;
          let i = La(r),
            { values: l, keys: u } = this.ct(e, t, a);
          if (!Array.isArray(i)) return (this.ut = u), l;
          let h = (n = this.ut) !== null && n !== void 0 ? n : (this.ut = []),
            m = [],
            v,
            g,
            b = 0,
          ...
          for (; b <= x && k <= A; )
            ...
            else if (h[b] === u[k]) (m[k] = ne(i[b], l[k])), b++, k++;
            else if (h[x] === u[A]) (m[A] = ne(i[x], l[A])), x--, A--;
            else if (h[b] === u[A])
              (m[A] = ne(i[b], l[A])), Be(r, m[A + 1], i[b]), b++, A--;
            else if (h[x] === u[k])
              (m[k] = ne(i[x], l[k])), Be(r, i[b], i[x]), x--, k++;
            else if (
              (v === void 0 && ((v = ja(u, k, A)), (g = ja(h, b, x))), v.has(h[b]))
            )
              if (v.has(h[x])) {
                let C = g.get(u[k]),
                  B = C !== void 0 ? i[C] : null;
                if (B === null) {
                  let R = Be(r, i[b]);
                  ne(R, l[k]), (m[k] = R);
                } else (m[k] = ne(B, l[k])), Be(r, i[b], B), (i[C] = null);
                k++;
              } else St(i[x]), x--;
            else St(i[b]), b++;
          for (; k <= A; ) {
  ...
  var Ua = D0(
    class extends S0 {
      ...
      update(r, [e]) {
        if (e === o0 || e === G) return e;
        let t = r.element,
          a = r.name;
        if (r.type === c0.PROPERTY) {
          if (e === t[a]) return o0;
        } else if (r.type === c0.BOOLEAN_ATTRIBUTE) {
          if (!!e === t.hasAttribute(a)) return o0;
        } else if (r.type === c0.ATTRIBUTE && t.getAttribute(a) === e + '')
          return o0;
        return kt(r), e;
      }
    }
  ...
  var Ue = (r, e) => {
      ...
      for (let i of n)
        (a = (t = i)._$AO) === null || a === void 0 || a.call(t, e, !1), Ue(i, e);
      return !0;
    },
    At = (r) => {
      let e, t;
  ...
  function Gi(r) {
    this._$AN !== void 0 ? (At(this), (this._$AM = r), Va(this)) : (this._$AM = r);
  }
  function Ki(r, e = !1, t = 0) {
    let a = this._$AH,
      n = this._$AN;
    if (n !== void 0 && n.size !== 0)
      if (e)
        if (Array.isArray(a))
          for (let i = t; i < a.length; i++) Ue(a[i], !1), At(a[i]);
        else a != null && (Ue(a, !1), At(a));
      else Ue(this, r);
  }
  var Wi = (r) => {
      var e, t, a, n;
      r.type == c0.CHILD &&
        (((e = (a = r)._$AP) !== null && e !== void 0) || (a._$AP = Ki),
        ((t = (n = r)._$AQ) !== null && t !== void 0) || (n._$AQ = Gi));
    },
    Mt = class extends S0 {
      constructor() {
      ...
      _$AT(e, t, a) {
        super._$AT(e, t, a), Va(this), (this.isConnected = e._$AU);
      }
      _$AO(e, t = !0) {
        var a, n;
        e !== this.isConnected &&
          ((this.isConnected = e),
          e
            ? (a = this.reconnected) === null || a === void 0 || a.call(this)
            : (n = this.disconnected) === null || n === void 0 || n.call(this)),
          t && (Ue(this, e), At(this));
      }
      setValue(e) {
    ...
    zt = D0(
      class extends Mt {
        ...
        update(r, [e]) {
          ...
          let a = e !== this.G;
          return (
            a && this.G !== void 0 && this.ot(void 0),
            (a || this.rt !== this.lt) &&
              ((this.G = e),
              (this.dt = (t = r.options) === null || t === void 0 ? void 0 : t.host),
              this.ot((this.lt = r.element))),
            G
          );
        }
        ot(r) {
          ...
          if (typeof this.G == 'function') {
            let t = (e = this.dt) !== null && e !== void 0 ? e : globalThis,
              a = xr.get(t);
            a === void 0 && ((a = new WeakMap()), xr.set(t, a)),
              a.get(this.G) !== void 0 && this.G.call(this.dt, void 0),
              a.set(this.G, r),
              r !== void 0 && this.G.call(this.dt, r);
          } else this.G.value = r;
        }
        get rt() {
          var r, e, t;
          return typeof this.G == 'function'
            ? (e = xr.get(
                (r = this.dt) !== null && r !== void 0 ? r : globalThis
              )) === null || e === void 0
              ? void 0
              : e.get(this.G)
            : (t = this.G) === null || t === void 0
              ? void 0
              : t.value;
        }
        disconnected() {
    ...
    class extends S0 {
      constructor(r) {
        ...
        if (
          ...
          r.type !== c0.ATTRIBUTE ||
            r.name !== 'class' ||
            ((e = r.strings) === null || e === void 0 ? void 0 : e.length) > 2)
        )
          throw Error(
      ...
      update(r, [e]) {
        ...
        if (this.it === void 0) {
          ...
          for (let i in e)
            e[i] &&
              !(!((t = this.nt) === null || t === void 0) && t.has(i)) &&
              this.it.add(i);
          return this.render(e);
        }
        let n = r.element.classList;
        this.it.forEach((i) => {
        ...
        for (let i in e) {
          let l = !!e[i];
          l === this.it.has(i) ||
            (!((a = this.nt) === null || a === void 0) && a.has(i)) ||
            (l ? (n.add(i), this.it.add(i)) : (n.remove(i), this.it.delete(i)));
        }
        return o0;
      }
    }
  ...
  function Sr(r, e, t) {
    r.addEventListener
      ...
      : r.attachEvent &&
        r.attachEvent('on'.concat(e), function () {
          t(window.event);
        });
  }
  function Xa(r, e) {
    for (var t = e.slice(0, e.length - 1), a = 0; a < t.length; a++)
      t[a] = r[t[a].toLowerCase()];
    return t;
  }
  function Za(r) {
    typeof r != 'string' && (r = ''), (r = r.replace(/\s/g, ''));
    for (var e = r.split(','), t = e.lastIndexOf(''); t >= 0; )
      (e[t - 1] += ','), e.splice(t, 1), (t = e.lastIndexOf(''));
    return e;
  }
  function Yi(r, e) {
    for (
      var t = r.length >= e.length ? r : e,
  ...
  var Ja = {
    ...
    h0 = { 16: !1, 18: !1, 17: !1, 91: !1 },
    u0 = {};
  for (Ge = 1; Ge < 20; Ge++) Ja['f'.concat(Ge)] = 111 + Ge;
  var Ge,
    Y = [],
    Qa = 'all',
    en = [],
    Et = function (e) {
      return (
        Ja[e.toLowerCase()] || ve[e.toLowerCase()] || e.toUpperCase().charCodeAt(0)
      );
    };
  function tn(r) {
    Qa = r || 'all';
  ...
  function Zi(r) {
    ...
    return (
      (e.isContentEditable ||
        ((t === 'INPUT' || t === 'TEXTAREA' || t === 'SELECT') && !e.readOnly)) &&
        (a = !1),
      a
    );
  }
  function Ji(r) {
    return typeof r == 'string' && (r = Et(r)), Y.indexOf(r) !== -1;
  }
  function Qi(r, e) {
    var t, a;
    r || (r = Ke());
    for (var n in u0)
      if (Object.prototype.hasOwnProperty.call(u0, n))
        for (t = u0[n], a = 0; a < t.length; )
          t[a].scope === r ? t.splice(a, 1) : a++;
    Ke() === r && tn(e || 'all');
  }
  function es(r) {
    var e = r.keyCode || r.which || r.charCode,
      t = Y.indexOf(e);
    if (
      (t >= 0 && Y.splice(t, 1),
      r.key && r.key.toLowerCase() === 'meta' && Y.splice(0, Y.length),
      (e === 93 || e === 224) && (e = 91),
      e in h0)
    ) {
      h0[e] = !1;
      for (var a in ve) ve[a] === e && (G0[a] = !1);
    }
  }
  function ts(r) {
    if (!r)
      Object.keys(u0).forEach(function (l) {
        return delete u0[l];
      });
    ...
    else if (typeof r == 'object') r.key && Ar(r);
      ...
      typeof n == 'function' && ((i = n), (n = '')),
        Ar({ key: r, scope: n, method: i, splitKey: '+' });
    }
  }
  var Ar = function (e) {
    var t = e.key,
    ...
    u.forEach(function (h) {
      ...
      if (u0[b]) {
        a || (a = Ke());
        var x = v > 1 ? Xa(ve, m) : [];
        u0[b] = u0[b].map(function (k) {
          var A = n ? k.method === n : !0;
          return A && k.scope === a && Yi(k.mods, x) ? {} : k;
        });
      }
    });
  };
  function Ka(r, e, t) {
    ...
    if (e.scope === t || e.scope === 'all') {
      a = e.mods.length > 0;
      for (var n in h0)
        Object.prototype.hasOwnProperty.call(h0, n) &&
          ((!h0[n] && e.mods.indexOf(+n) > -1) ||
            (h0[n] && e.mods.indexOf(+n) === -1)) &&
          (a = !1);
      ((e.mods.length === 0 && !h0[16] && !h0[18] && !h0[17] && !h0[91]) ||
        a ||
        e.shortcut === '*') &&
        e.method(r, e) === !1 &&
  ...
  function Wa(r) {
    ...
    if (G0.filter.call(this, r)) {
      if (
        ((t === 93 || t === 224) && (t = 91),
        Y.indexOf(t) === -1 && t !== 229 && Y.push(t),
        ['ctrlKey', 'altKey', 'shiftKey', 'metaKey'].forEach(function (x) {
          var k = Ga[x];
          r[x] && Y.indexOf(k) === -1
            ? Y.push(k)
            : !r[x] && Y.indexOf(k) > -1
              ...
              : x === 'metaKey' &&
                r[x] &&
                Y.length === 3 &&
                (r.ctrlKey || r.shiftKey || r.altKey || (Y = Y.slice(Y.indexOf(k))));
        }),
        t in h0)
      ) {
        h0[t] = !0;
        for (var a in ve) ve[a] === t && (G0[a] = !0);
        if (!e) return;
      }
      for (var n in h0)
        Object.prototype.hasOwnProperty.call(h0, n) && (h0[n] = r[Ga[n]]);
      r.getModifierState &&
        !(r.altKey && !r.ctrlKey) &&
        r.getModifierState('AltGraph') &&
        (Y.indexOf(17) === -1 && Y.push(17),
        Y.indexOf(18) === -1 && Y.push(18),
        (h0[17] = !0),
        (h0[18] = !0));
      var i = Ke();
      if (e)
        for (var l = 0; l < e.length; l++)
          e[l].scope === i &&
            ((r.type === 'keydown' && e[l].keydown) ||
              (r.type === 'keyup' && e[l].keyup)) &&
            Ka(r, e[l], i);
      if (t in u0) {
        for (var u = 0; u < u0[t].length; u++)
          if (
            ((r.type === 'keydown' && u0[t][u].keydown) ||
              (r.type === 'keyup' && u0[t][u].keyup)) &&
            u0[t][u].key
          ) {
            for (
              var h = u0[t][u], m = h.splitKey, v = h.key.split(m), g = [], b = 0;
              b < v.length;
              b++
            )
              g.push(Et(v[b]));
            g.sort().join('') === Y.sort().join('') && Ka(r, h, i);
          }
      }
    }
  }
  function rs(r) {
    return en.indexOf(r) > -1;
  }
  function G0(r, e, t) {
    Y = [];
    var a = Za(r),
      ...
      v = '+';
    for (
      t === void 0 && typeof e == 'function' && (t = e),
        Object.prototype.toString.call(e) === '[object Object]' &&
          (e.scope && (i = e.scope),
          e.element && (l = e.element),
          e.keyup && (h = e.keyup),
          e.keydown !== void 0 && (m = e.keydown),
          typeof e.splitKey == 'string' && (v = e.splitKey)),
        typeof e == 'string' && (i = e);
      u < a.length;
      u++
    )
    ...
    typeof l < 'u' &&
      ...
      window &&
      (en.push(l),
      Sr(l, 'keydown', function (g) {
        Wa(g);
      }),
      Sr(window, 'focus', function () {
        Y = [];
      }),
      Sr(l, 'keyup', function (g) {
        Wa(g), es(g);
      }));
  }
  var Mr = {
    ...
    getScope: Ke,
    deleteScope: Qi,
    getPressedKeyCodes: Xi,
    isPressed: Ji,
    filter: Zi,
    unbind: ts,
  };
  for (Ct in Mr) Object.prototype.hasOwnProperty.call(Mr, Ct) && (G0[Ct] = Mr[Ct]);
  var Ct;
  typeof window < 'u' &&
    ((Ya = window.hotkeys),
    (G0.noConflict = function (r) {
      return r && window.hotkeys === G0 && (window.hotkeys = Ya), G0;
    }),
    (window.hotkeys = G0));
  var Ya,
    y0 = G0;
  var We = function (r, e, t, a) {
      var n = arguments.length,
        i = n < 3 ? e : a === null ? (a = Object.getOwnPropertyDescriptor(e, t)) : a,
        l;
      if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
        i = Reflect.decorate(r, e, t, a);
      else
        for (var u = r.length - 1; u >= 0; u--)
          (l = r[u]) && (i = (n < 3 ? l(i) : n > 3 ? l(e, t, i) : l(e, t)) || i);
    ...
    ge = class extends g0 {
      ...
      render() {
        ...
        if (!this.hideBreadcrumbs) {
          let t = [];
          for (let a of this.breadcrumbs)
            t.push(r0`<button
            tabindex="-1"
            @click=${() => this.selectParent(a)}
            class="breadcrumb"
          >
            ${a}
          </button>`);
          e = r0`<div class="breadcrumb-list">
        <button
          tabindex="-1"
    ...
    `;
      ...
      setSearch(e) {
        this._inputRef.value && (this._inputRef.value.value = e);
      }
      focusSearch() {
  ...
  `;
  We([W()], ge.prototype, 'placeholder', void 0);
  We([W({ type: Boolean })], ge.prototype, 'hideBreadcrumbs', void 0);
  We([W()], ge.prototype, 'breadcrumbHome', void 0);
  We([W({ type: Array })], ge.prototype, 'breadcrumbs', void 0);
  ge = We([ae('ninja-header')], ge);
  var Ye = class extends S0 {
    constructor(e) {
      if ((super(e), (this.et = G), e.type !== c0.CHILD))
        throw Error(
  ...
  function* an(r, e) {
    ...
    if (r !== void 0) {
      let a = -1;
      for (let n of r) a > -1 && (yield t ? e(a) : e), a++, yield n;
    }
  }
  function nn(r, e, t, a) {
    var n = arguments.length,
  ...
  var sn = j0`:host{font-family:var(--mdc-icon-font, "Material Icons");font-weight:normal;font-style:normal;font-size:var(--mdc-icon-size, 24px);line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale;font-feature-settings:"liga"}`;
  var Tr = class extends g0 {
    render() {
      return r0`<span><slot></slot></span>`;
    }
  };
  Tr.styles = [sn];
  Tr = nn([ae('mwc-icon')], Tr);
  var Bt = function (r, e, t, a) {
      var n = arguments.length,
        i = n < 3 ? e : a === null ? (a = Object.getOwnPropertyDescriptor(e, t)) : a,
        l;
      if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
    ...
    De = class extends g0 {
      ...
      render() {
        let e;
        this.action.mdIcon
          ? (e = r0`<mwc-icon part="ninja-icon" class="ninja-icon"
        >${this.action.mdIcon}</mwc-icon
      >`)
          : this.action.icon && (e = rn(this.action.icon || ''));
        let t;
        this.action.hotkey &&
          (this.hotKeysJoinedView
            ? (t = this.action.hotkey.split(',').map((n) => {
                let i = n.split('+'),
                  l = r0`${an(
                    i.map((u) => r0`<kbd>${u}</kbd>`),
                    '+'
                  )}`;
                return r0`<div class="ninja-hotkey ninja-hotkeys">
            ${l}
          </div>`;
              }))
            : (t = this.action.hotkey.split(',').map((n) => {
                let l = n
                  .split('+')
                  .map((u) => r0`<kbd class="ninja-hotkey">${u}</kbd>`);
                return r0`<kbd class="ninja-hotkeys">${l}</kbd>`;
              })));
        let a = { selected: this.selected, 'ninja-action': !0 };
        return r0`
      <div
        class="ninja-action"
  ...
  `;
  Bt([W({ type: Object })], De.prototype, 'action', void 0);
  Bt([W({ type: Boolean })], De.prototype, 'selected', void 0);
  Bt([W({ type: Boolean })], De.prototype, 'hotKeysJoinedView', void 0);
  De = Bt([ae('ninja-action')], De);
  var ln = r0` <div class="modal-footer" slot="footer">
  <span class="help">
    <svg
      version="1.0"
...
`;
  var a0 = function (r, e, t, a) {
    ...
    J = class extends g0 {
      ...
      setParent(e) {
        e ? (this._currentRoot = e) : (this._currentRoot = void 0),
      ...
      get breadcrumbs() {
        var e;
        let t = [],
          a = (e = this._selected) === null || e === void 0 ? void 0 : e.parent;
        if (a)
          for (t.push(a); a; ) {
            let n = this._flatData.find((i) => i.id === a);
            n?.parent && t.push(n.parent), (a = n ? n.parent : void 0);
          }
        return t.reverse();
      }
      connectedCallback() {
      ...
      _flattern(e, t) {
        ...
        return (
          ...
          e
            .map((n) => {
              let i = n.children && n.children.some((u) => typeof u == 'string'),
                l = { ...n, parent: n.parent || t };
              return (
                i ||
                  (l.children &&
                    l.children.length &&
                    ((t = n.id), (a = [...a, ...l.children])),
                  (l.children = l.children ? l.children.map((u) => u.id) : [])),
                l
              );
            })
            .concat(a.length ? this._flattern(a, t) : a)
        );
      }
      update(e) {
        e.has('data') &&
          ...
          this._flatData
            ...
            .forEach((t) => {
              y0(t.hotkey, (a) => {
                a.preventDefault(), t.handler && t.handler(t);
              });
            })),
          super.update(e);
      }
      ...
      _unregisterInternalHotkeys() {
        this.openHotkey && y0.unbind(this.openHotkey),
          this.selectHotkey && y0.unbind(this.selectHotkey),
          this.goBackHotkey && y0.unbind(this.goBackHotkey),
          this.navigationDownHotkey && y0.unbind(this.navigationDownHotkey),
          this.navigationUpHotkey && y0.unbind(this.navigationUpHotkey),
          this.closeHotkey && y0.unbind(this.closeHotkey);
      }
      _actionFocused(e, t) {
      ...
      render() {
        let e = { bump: this._bump, 'modal-content': !0 },
          t = { visible: this.visible, modal: !0 },
          n = this._flatData
            .filter((u) => {
              var h;
              let m = new RegExp(this._search, 'gi'),
                v =
                  u.title.match(m) ||
                  ((h = u.keywords) === null || h === void 0 ? void 0 : h.match(m));
              return (
                ((!this._currentRoot && this._search) ||
                  u.parent === this._currentRoot) &&
                v
              );
            })
            .reduce(
              (u, h) => u.set(h.section, [...(u.get(h.section) || []), h]),
              new Map()
            );
        (this._actionMatches = [...n.values()].flat()),
          this._actionMatches.length > 0 &&
            this._selectedIndex === -1 &&
            (this._selected = this._actionMatches[0]),
          this._actionMatches.length === 0 && (this._selected = void 0);
        let i = (u) =>
            r0` ${Fa(
              u,
              (h) => h.id,
              (h) => {
                var m;
                return r0`<ninja-action
            exportparts="ninja-action,ninja-selected,ninja-icon"
            .selected=${Ua(
              h.id ===
                ((m = this._selected) === null || m === void 0 ? void 0 : m.id)
            )}
            .hotKeysJoinedView=${this.hotKeysJoinedView}
            @mouseover=${(v) => this._actionFocused(h, v)}
            @actionsSelected=${(v) => this._actionSelected(v.detail)}
            .action=${h}
          ></ninja-action>`;
              }
            )}`,
        ...
        return (
          n.forEach((u, h) => {
            let m = h ? r0`<div class="group-header">${h}</div>` : void 0;
            l.push(r0`${m}${i(u)}`);
          }),
          r0`
      <div @click=${this._overlayClick} class=${Ve(t)}>
    ...
    `
      ...
      _actionSelected(e) {
        ...
        if (
          ...
          if (
            (e.children &&
              ((t = e.children) === null || t === void 0 ? void 0 : t.length) > 0 &&
  ...
  J.styles = [on];
  a0([W({ type: String })], J.prototype, 'placeholder', void 0);
  a0([W({ type: Boolean })], J.prototype, 'disableHotkeys', void 0);
  a0([W({ type: Boolean })], J.prototype, 'hideBreadcrumbs', void 0);
  a0([W()], J.prototype, 'openHotkey', void 0);
  a0([W()], J.prototype, 'navigationUpHotkey', void 0);
  a0([W()], J.prototype, 'navigationDownHotkey', void 0);
  a0([W()], J.prototype, 'closeHotkey', void 0);
  a0([W()], J.prototype, 'goBackHotkey', void 0);
  a0([W()], J.prototype, 'selectHotkey', void 0);
  a0([W({ type: Boolean })], J.prototype, 'hotKeysJoinedView', void 0);
  a0([W({ type: Boolean })], J.prototype, 'noAutoLoadMdIcons', void 0);
  a0(
    [
      W({
        type: Array,
  ...
  a0([V0()], J.prototype, 'visible', void 0);
  a0([V0()], J.prototype, '_bump', void 0);
  a0([V0()], J.prototype, '_actionMatches', void 0);
  a0([V0()], J.prototype, '_search', void 0);
  a0([V0()], J.prototype, '_currentRoot', void 0);
  a0([V0()], J.prototype, '_flatData', void 0);
  a0([V0()], J.prototype, 'breadcrumbs', null);
  a0([V0()], J.prototype, '_selected', void 0);
  J = a0([ae('ninja-keys')], J);
  var A0 = class r {
      constructor(e, t, a) {
        (this.lexer = void 0),
          (this.start = void 0),
    ...
    C0 = class r {
      ...
      range(e, t) {
        return new r(t, A0.range(this, e));
      }
    },
    T = class r {
      constructor(e, t) {
        ...
        if (l && l.start <= l.end) {
          ...
          (n = l.start),
            ...
            n === u.length
              ? (a += ' at end of input: ')
              : (a += ' at position ' + (n + 1) + ': ');
          var h = u.slice(n, i).replace(/[^]/g, '$&\u0332'),
            m;
          n > 15 ? (m = '\u2026' + u.slice(n - 15, n)) : (m = u.slice(0, n));
          var v;
          i + 15 < u.length ? (v = u.slice(i, i + 15) + '\u2026') : (v = u.slice(i)),
            (a += m + h + v);
        }
        var g = new Error(a);
        return (
          (g.name = 'ParseError'),
          (g.__proto__ = r.prototype),
          (g.position = n),
  ...
  var as = function (e, t) {
    ...
    os = /[&><"']/g;
  function us(r) {
    return String(r).replace(os, (e) => ls[e]);
  }
  var Pn = function r(e) {
  ...
  var et = class {
      constructor(e) {
        ...
        for (var t in jt)
          if (jt.hasOwnProperty(t)) {
            var a = jt[t];
            this[t] =
              e[t] !== void 0 ? (a.processor ? a.processor(e[t]) : e[t]) : ms(a);
          }
      }
    ...
    O0 = class {
      ...
      sup() {
        return R0[fs[this.id]];
      }
      sub() {
        return R0[ps[this.id]];
      }
      fracNum() {
        return R0[vs[this.id]];
      }
      fracDen() {
        return R0[gs[this.id]];
      }
      cramp() {
        return R0[ys[this.id]];
      }
      text() {
        return R0[bs[this.id]];
      }
      isTight() {
        return this.size >= 2;
      }
    ...
    fs = [tt, z0, tt, z0, Oe, f0, Oe, f0],
    ps = [z0, z0, z0, z0, f0, f0, f0, f0],
    vs = [Ne, Y0, tt, z0, Oe, f0, Oe, f0],
    gs = [Y0, Y0, z0, z0, f0, f0, f0, f0],
    ys = [Ut, Ut, Y0, Y0, z0, z0, f0, f0],
    bs = [Zr, Ut, Ne, Y0, Ne, Y0, Ne, Y0],
    O = { DISPLAY: R0[Zr], TEXT: R0[Ne], SCRIPT: R0[tt], SCRIPTSCRIPT: R0[Oe] },
    Ir = [
      {
        name: 'latin',
        blocks: [
  ...
  function xs(r) {
    for (var e = 0; e < Ir.length; e++)
      for (var t = Ir[e], a = 0; a < t.blocks.length; a++) {
        var n = t.blocks[a];
  ...
  var Ft = [];
  Ir.forEach((r) => r.blocks.forEach((e) => Ft.push(...e)));
  function Ln(r) {
    for (var e = 0; e < Ft.length; e += 2)
      if (r >= Ft[e] && r <= Ft[e + 1]) return !0;
    return !1;
  }
  var $e = 80,
    ws = function (e, t) {
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`
  ...
  function Jr(r, e, t) {
    if (!_0[e]) throw new Error('Font metrics not found for font: ' + e + '.');
    var a = r.charCodeAt(0),
      n = _0[e][a];
    if (
      (!n && r[0] in hn && ((a = hn[r[0]].charCodeAt(0)), (n = _0[e][a])),
      !n && t === 'text' && Ln(a) && (n = _0[e][77]),
      n)
    )
  ...
  function $s(r) {
    var e;
    if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !zr[e])) {
      var t = (zr[e] = { cssEmPerMu: Dt.quad[e] / 18 });
      for (var a in Dt) Dt.hasOwnProperty(a) && (t[a] = Dt[a][e]);
    }
    return zr[e];
  }
  var Ns = [
    ...
    cn = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
    dn = function (e, t) {
      return t.size < 2 ? e : Ns[e - 1][t.size - 1];
    },
    Vt = class r {
      constructor(e) {
        (this.style = void 0),
          ...
          (this.sizeMultiplier = cn[this.size - 1]),
      ...
      havingStyle(e) {
        return this.style === e
          ? this
          : this.extend({ style: e, size: dn(this.textSize, e) });
      }
      havingCrampedStyle() {
      ...
      fontMetrics() {
        return (
          this._fontMetrics || (this._fontMetrics = $s(this.size)), this._fontMetrics
        );
      }
      getColor() {
  ...
  var Pr = {
    ...
    Os = { ex: !0, em: !0, mu: !0 },
    jn = function (e) {
      return typeof e != 'string' && (e = e.unit), e in Pr || e in Os || e === 'ex';
    },
    t0 = function (e, t) {
      var a;
      if (e.unit in Pr) a = Pr[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
    ...
    Vn = function (e) {
      var t = '<' + e;
      this.classes.length && (t += ' class="' + $.escape(le(this.classes)) + '"');
      var a = '';
      for (var n in this.style)
        this.style.hasOwnProperty(n) &&
          (a += $.hyphenate(n) + ':' + this.style[n] + ';');
      a && (t += ' style="' + $.escape(a) + '"');
    ...
    we = class {
      ...
      toNode() {
        return Un.call(this, 'span');
      }
      toMarkup() {
        return Vn.call(this, 'span');
      }
    },
    rt = class {
      constructor(e, t, a, n) {
      ...
      toNode() {
        return Un.call(this, 'a');
      }
      toMarkup() {
        return Vn.call(this, 'a');
      }
    },
    Lr = class {
      constructor(e, t, a) {
    ...
    w0 = class {
      constructor(e, t, a, n, i, l, u, h) {
        (this.text = void 0),
          ...
          (this.style = h || {}),
          (this.maxFontSize = 0);
        var m = xs(this.text.charCodeAt(0));
        m && this.classes.push(m + '_fallback'),
          /[îïíì]/.test(this.text) && (this.text = Rs[this.text]);
      }
      hasClass(e) {
        return $.contains(this.classes, e);
      }
      ...
      toNode() {
        ...
        return (
          this.alternate
            ...
            : t.setAttribute('d', un[this.pathName]),
          t
        );
      }
      toMarkup() {
        return this.alternate
          ? '<path d="' + $.escape(this.alternate) + '"/>'
          : '<path d="' + $.escape(un[this.pathName]) + '"/>';
      }
    },
    at = class {
      constructor(e) {
  ...
  var qs = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
    Hs = { 'accent-token': 1, mathord: 1, 'op-token': 1, spacing: 1, textord: 1 },
    K = { math: {}, text: {} };
  function s(r, e, t, a, n, i) {
    (K[r][n] = { font: e, group: t, replace: a }), i && a && (K[r][a] = K[r][n]);
  }
  var o = 'math',
    S = 'text',
    c = 'main',
  ...
  s(o, c, y, '\u2021', '\\ddag');
  s(S, c, y, '\u2021', '\\ddag');
  s(S, c, y, '\u2021', '\\textdaggerdbl');
  s(o, c, p0, '\u23B1', '\\rmoustache', !0);
  s(o, c, M0, '\u23B0', '\\lmoustache', !0);
  s(o, c, p0, '\u27EF', '\\rgroup', !0);
  s(o, c, M0, '\u27EE', '\\lgroup', !0);
  s(o, c, D, '\u2213', '\\mp', !0);
  s(o, c, D, '\u2296', '\\ominus', !0);
  ...
  s(o, f, p, '\u22EC', '\\ntrianglelefteq', !0);
  s(o, f, p, '\u228A', '\\subsetneq', !0);
  s(o, f, p, '\uE01A', '\\@varsubsetneq');
  s(o, f, p, '\u2ACB', '\\subsetneqq', !0);
  s(o, f, p, '\uE017', '\\@varsubsetneqq');
  s(o, f, p, '\u226F', '\\ngtr', !0);
  s(o, f, p, '\uE00F', '\\@ngeqslant');
  s(o, f, p, '\uE00E', '\\@ngeqq');
  s(o, f, p, '\u2A88', '\\gneq', !0);
  ...
  s(o, f, p, '\u22E1', '\\nsucceq', !0);
  s(o, f, p, '\u22E9', '\\succnsim', !0);
  s(o, f, p, '\u2ABA', '\\succnapprox', !0);
  s(o, f, p, '\u2246', '\\ncong', !0);
  s(o, f, p, '\uE007', '\\@nshortparallel');
  s(o, f, p, '\u2226', '\\nparallel', !0);
  s(o, f, p, '\u22AF', '\\nVDash', !0);
  s(o, f, p, '\u22EB', '\\ntriangleright');
  s(o, f, p, '\u22ED', '\\ntrianglerighteq', !0);
  s(o, f, p, '\uE018', '\\@nsupseteqq');
  s(o, f, p, '\u228B', '\\supsetneq', !0);
  s(o, f, p, '\uE01B', '\\@varsupsetneq');
  s(o, f, p, '\u2ACC', '\\supsetneqq', !0);
  s(o, f, p, '\uE019', '\\@varsupsetneqq');
  s(o, f, p, '\u22AE', '\\nVdash', !0);
  s(o, f, p, '\u2AB5', '\\precneqq', !0);
  s(o, f, p, '\u2AB6', '\\succneqq', !0);
  s(o, f, p, '\uE016', '\\@nsubseteqq');
  ...
  s(o, f, y, '\u25CA', '\\lozenge');
  s(o, f, y, '\u24C8', '\\circledS');
  s(o, f, y, '\xAE', '\\circledR');
  s(S, f, y, '\xAE', '\\circledR');
  ...
  s(o, f, p, '\u2266', '\\leqq', !0);
  s(o, f, p, '\u2A7D', '\\leqslant', !0);
  s(o, f, p, '\u2A95', '\\eqslantless', !0);
  s(o, f, p, '\u2272', '\\lesssim', !0);
  s(o, f, p, '\u2A85', '\\lessapprox', !0);
  s(o, f, p, '\u224A', '\\approxeq', !0);
  s(o, f, D, '\u22D6', '\\lessdot');
  s(o, f, p, '\u22D8', '\\lll', !0);
  s(o, f, p, '\u2276', '\\lessgtr', !0);
  s(o, f, p, '\u22DA', '\\lesseqgtr', !0);
  s(o, f, p, '\u2A8B', '\\lesseqqgtr', !0);
  s(o, f, p, '\u2251', '\\doteqdot');
  s(o, f, p, '\u2253', '\\risingdotseq', !0);
  s(o, f, p, '\u2252', '\\fallingdotseq', !0);
  s(o, f, p, '\u223D', '\\backsim', !0);
  s(o, f, p, '\u22CD', '\\backsimeq', !0);
  s(o, f, p, '\u2AC5', '\\subseteqq', !0);
  s(o, f, p, '\u22D0', '\\Subset', !0);
  s(o, f, p, '\u228F', '\\sqsubset', !0);
  s(o, f, p, '\u227C', '\\preccurlyeq', !0);
  s(o, f, p, '\u22DE', '\\curlyeqprec', !0);
  s(o, f, p, '\u227E', '\\precsim', !0);
  s(o, f, p, '\u2AB7', '\\precapprox', !0);
  s(o, f, p, '\u22B2', '\\vartriangleleft');
  s(o, f, p, '\u22B4', '\\trianglelefteq');
  s(o, f, p, '\u22A8', '\\vDash', !0);
  s(o, f, p, '\u22AA', '\\Vvdash', !0);
  s(o, f, p, '\u2323', '\\smallsmile');
  s(o, f, p, '\u2322', '\\smallfrown');
  ...
  s(o, f, p, '\u22D1', '\\Supset', !0);
  s(o, f, p, '\u2290', '\\sqsupset', !0);
  s(o, f, p, '\u227D', '\\succcurlyeq', !0);
  s(o, f, p, '\u22DF', '\\curlyeqsucc', !0);
  s(o, f, p, '\u227F', '\\succsim', !0);
  s(o, f, p, '\u2AB8', '\\succapprox', !0);
  s(o, f, p, '\u22B3', '\\vartriangleright');
  s(o, f, p, '\u22B5', '\\trianglerighteq');
  s(o, f, p, '\u22A9', '\\Vdash', !0);
  s(o, f, p, '\u2223', '\\shortmid');
  s(o, f, p, '\u2225', '\\shortparallel');
  s(o, f, p, '\u226C', '\\between', !0);
  s(o, f, p, '\u22D4', '\\pitchfork', !0);
  s(o, f, p, '\u221D', '\\varpropto');
  s(o, f, p, '\u25C0', '\\blacktriangleleft');
  s(o, f, p, '\u2234', '\\therefore', !0);
  s(o, f, p, '\u220D', '\\backepsilon');
  s(o, f, p, '\u25B6', '\\blacktriangleright');
  s(o, f, p, '\u2235', '\\because', !0);
  s(o, f, p, '\u22D8', '\\llless');
  s(o, f, p, '\u22D9', '\\gggtr');
  s(o, f, D, '\u22B2', '\\lhd');
  ...
  s(o, f, p, '\u2251', '\\Doteq', !0);
  s(o, f, D, '\u2214', '\\dotplus', !0);
  s(o, f, D, '\u2216', '\\smallsetminus');
  s(o, f, D, '\u22D2', '\\Cap', !0);
  s(o, f, D, '\u22D3', '\\Cup', !0);
  s(o, f, D, '\u2A5E', '\\doublebarwedge', !0);
  s(o, f, D, '\u229F', '\\boxminus', !0);
  s(o, f, D, '\u229E', '\\boxplus', !0);
  s(o, f, D, '\u22C7', '\\divideontimes', !0);
  s(o, f, D, '\u22C9', '\\ltimes', !0);
  s(o, f, D, '\u22CA', '\\rtimes', !0);
  s(o, f, D, '\u22CB', '\\leftthreetimes', !0);
  s(o, f, D, '\u22CC', '\\rightthreetimes', !0);
  s(o, f, D, '\u22CF', '\\curlywedge', !0);
  s(o, f, D, '\u22CE', '\\curlyvee', !0);
  s(o, f, D, '\u229D', '\\circleddash', !0);
  s(o, f, D, '\u229B', '\\circledast', !0);
  s(o, f, D, '\u22C5', '\\centerdot');
  s(o, f, D, '\u22BA', '\\intercal', !0);
  s(o, f, D, '\u22D2', '\\doublecap');
  s(o, f, D, '\u22D3', '\\doublecup');
  s(o, f, D, '\u22A0', '\\boxtimes', !0);
  s(o, f, p, '\u21E2', '\\dashrightarrow', !0);
  s(o, f, p, '\u21E0', '\\dashleftarrow', !0);
  s(o, f, p, '\u21C7', '\\leftleftarrows', !0);
  s(o, f, p, '\u21C6', '\\leftrightarrows', !0);
  s(o, f, p, '\u21DA', '\\Lleftarrow', !0);
  s(o, f, p, '\u219E', '\\twoheadleftarrow', !0);
  s(o, f, p, '\u21A2', '\\leftarrowtail', !0);
  s(o, f, p, '\u21AB', '\\looparrowleft', !0);
  s(o, f, p, '\u21CB', '\\leftrightharpoons', !0);
  s(o, f, p, '\u21B6', '\\curvearrowleft', !0);
  s(o, f, p, '\u21BA', '\\circlearrowleft', !0);
  s(o, f, p, '\u21B0', '\\Lsh', !0);
  s(o, f, p, '\u21C8', '\\upuparrows', !0);
  s(o, f, p, '\u21BF', '\\upharpoonleft', !0);
  s(o, f, p, '\u21C3', '\\downharpoonleft', !0);
  s(o, c, p, '\u22B6', '\\origof', !0);
  s(o, c, p, '\u22B7', '\\imageof', !0);
  s(o, f, p, '\u22B8', '\\multimap', !0);
  s(o, f, p, '\u21AD', '\\leftrightsquigarrow', !0);
  s(o, f, p, '\u21C9', '\\rightrightarrows', !0);
  s(o, f, p, '\u21C4', '\\rightleftarrows', !0);
  s(o, f, p, '\u21A0', '\\twoheadrightarrow', !0);
  s(o, f, p, '\u21A3', '\\rightarrowtail', !0);
  s(o, f, p, '\u21AC', '\\looparrowright', !0);
  s(o, f, p, '\u21B7', '\\curvearrowright', !0);
  s(o, f, p, '\u21BB', '\\circlearrowright', !0);
  s(o, f, p, '\u21B1', '\\Rsh', !0);
  s(o, f, p, '\u21CA', '\\downdownarrows', !0);
  s(o, f, p, '\u21BE', '\\upharpoonright', !0);
  s(o, f, p, '\u21C2', '\\downharpoonright', !0);
  s(o, f, p, '\u21DD', '\\rightsquigarrow', !0);
  s(o, f, p, '\u21DD', '\\leadsto');
  s(o, f, p, '\u21DB', '\\Rrightarrow', !0);
  s(o, f, p, '\u21BE', '\\restriction');
  s(o, c, y, '\u2018', '`');
  s(o, c, y, '$', '\\$');
  s(S, c, y, '$', '\\$');
  ...
  s(o, c, N, '\u03C8', '\\psi', !0);
  s(o, c, N, '\u03C9', '\\omega', !0);
  s(o, c, N, '\u03B5', '\\varepsilon', !0);
  s(o, c, N, '\u03D1', '\\vartheta', !0);
  s(o, c, N, '\u03D6', '\\varpi', !0);
  s(o, c, N, '\u03F1', '\\varrho', !0);
  s(o, c, N, '\u03C2', '\\varsigma', !0);
  s(o, c, N, '\u03C6', '\\varphi', !0);
  s(o, c, D, '\u2217', '*', !0);
  s(o, c, D, '+', '+');
  s(o, c, D, '\u2212', '-', !0);
  ...
  s(o, c, y, '\u2202', '\\partial', !0);
  s(o, c, D, '\u2298', '\\oslash', !0);
  s(o, f, D, '\u229A', '\\circledcirc', !0);
  s(o, f, D, '\u22A1', '\\boxdot', !0);
  s(o, c, D, '\u25B3', '\\bigtriangleup');
  s(o, c, D, '\u25BD', '\\bigtriangledown');
  s(o, c, D, '\u2020', '\\dagger');
  s(o, c, D, '\u22C4', '\\diamond');
  s(o, c, D, '\u22C6', '\\star');
  s(o, c, D, '\u25C3', '\\triangleleft');
  s(o, c, D, '\u25B9', '\\triangleright');
  s(o, c, M0, '{', '\\{');
  s(S, c, y, '{', '\\{');
  s(S, c, y, '{', '\\textbraceleft');
  s(o, c, p0, '}', '\\}');
  s(S, c, y, '}', '\\}');
  s(S, c, y, '}', '\\textbraceright');
  s(o, c, M0, '{', '\\lbrace');
  s(o, c, p0, '}', '\\rbrace');
  s(o, c, M0, '[', '\\lbrack', !0);
  s(S, c, y, '[', '\\lbrack', !0);
  ...
  s(o, c, y, '\u2225', '\\Vert');
  s(S, c, y, '\u2225', '\\textbardbl');
  s(S, c, y, '~', '\\textasciitilde');
  s(S, c, y, '\\', '\\textbackslash');
  s(S, c, y, '^', '\\textasciicircum');
  s(o, c, p, '\u2191', '\\uparrow', !0);
  s(o, c, p, '\u21D1', '\\Uparrow', !0);
  s(o, c, p, '\u2193', '\\downarrow', !0);
  s(o, c, p, '\u21D3', '\\Downarrow', !0);
  ...
  s(o, c, i0, '\u2A06', '\\bigsqcup');
  s(o, c, i0, '\u222B', '\\smallint');
  s(S, c, Re, '\u2026', '\\textellipsis');
  s(o, c, Re, '\u2026', '\\mathellipsis');
  s(S, c, Re, '\u2026', '\\ldots', !0);
  s(o, c, Re, '\u2026', '\\ldots', !0);
  s(o, c, Re, '\u22EF', '\\@cdots', !0);
  s(o, c, Re, '\u22F1', '\\ddots', !0);
  ...
  s(S, c, y, '\u2014', '\\textemdash');
  s(S, c, y, '\u2018', '`', !0);
  s(S, c, y, '\u2018', '\\textquoteleft');
  s(S, c, y, '\u2019', "'", !0);
  s(S, c, y, '\u2019', '\\textquoteright');
  s(S, c, y, '\u201C', '``', !0);
  s(S, c, y, '\u201C', '\\textquotedblleft');
  s(S, c, y, '\u201D', "''", !0);
  s(S, c, y, '\u201D', '\\textquotedblright');
  s(o, c, y, '\xB0', '\\degree', !0);
  s(S, c, y, '\xB0', '\\degree');
  s(S, c, y, '\xB0', '\\textdegree', !0);
  s(o, c, y, '\xA3', '\\pounds');
  s(o, c, y, '\xA3', '\\mathsterling', !0);
  s(S, c, y, '\xA3', '\\pounds');
  s(S, c, y, '\xA3', '\\textsterling', !0);
  s(o, f, y, '\u2720', '\\maltese');
  s(S, f, y, '\u2720', '\\maltese');
  var fn = '0123456789/@."';
  for ($t = 0; $t < fn.length; $t++) (Cr = fn.charAt($t)), s(o, c, y, Cr, Cr);
  var Cr,
    $t,
    pn = '0123456789!@*()-=+";:?/.,';
  for (Nt = 0; Nt < pn.length; Nt++) (Er = pn.charAt(Nt)), s(S, c, y, Er, Er);
  var Er,
    Nt,
    Gt = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
  for (Ot = 0; Ot < Gt.length; Ot++)
    (Xe = Gt.charAt(Ot)), s(o, c, N, Xe, Xe), s(S, c, y, Xe, Xe);
  var Xe, Ot;
  s(o, f, y, 'C', '\u2102');
  s(S, f, y, 'C', '\u2102');
  s(o, f, y, 'H', '\u210D');
  ...
  s(S, c, N, 'h', '\u210E');
  var _ = '';
  for (d0 = 0; d0 < Gt.length; d0++)
    (Q = Gt.charAt(d0)),
      (_ = String.fromCharCode(55349, 56320 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56372 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56424 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56580 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56684 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56736 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56788 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      (_ = String.fromCharCode(55349, 56840 + d0)),
      s(o, c, N, Q, _),
      s(S, c, y, Q, _),
      ...
      s(S, c, y, Q, _),
      d0 < 26 &&
        ((_ = String.fromCharCode(55349, 56632 + d0)),
        s(o, c, N, Q, _),
        s(S, c, y, Q, _),
        (_ = String.fromCharCode(55349, 56476 + d0)),
        s(o, c, N, Q, _),
        s(S, c, y, Q, _));
  var Q, d0;
  _ = String.fromCharCode(55349, 56668);
  s(o, c, N, 'k', _);
  s(S, c, y, 'k', _);
  for (ie = 0; ie < 10; ie++)
    (K0 = ie.toString()),
      (_ = String.fromCharCode(55349, 57294 + ie)),
      s(o, c, N, K0, _),
      s(S, c, y, K0, _),
      (_ = String.fromCharCode(55349, 57314 + ie)),
      s(o, c, N, K0, _),
      s(S, c, y, K0, _),
      (_ = String.fromCharCode(55349, 57324 + ie)),
      s(o, c, N, K0, _),
      s(S, c, y, K0, _),
      (_ = String.fromCharCode(55349, 57334 + ie)),
      s(o, c, N, K0, _),
      s(S, c, y, K0, _);
  var K0,
    ie,
    jr = '\xD0\xDE\xFE';
  for (Rt = 0; Rt < jr.length; Rt++)
    (Ze = jr.charAt(Rt)), s(o, c, N, Ze, Ze), s(S, c, y, Ze, Ze);
  var Ze,
    Rt,
    _t = [
    ...
    Is = function (e, t) {
      ...
      if (119808 <= i && i < 120484) {
        ...
        return [_t[u][2], _t[u][l]];
      } else if (120782 <= i && i <= 120831) {
        var h = Math.floor((i - 120782) / 10);
        return [vn[h][2], vn[h][l]];
      } else {
        if (i === 120485 || i === 120486) return [_t[0][2], _t[0][l]];
    ...
    Qt = function (e, t, a) {
      return (
        K[a][e] && K[a][e].replace && (e = K[a][e].replace),
        { value: e, metrics: Jr(e, t, a) }
      );
    },
    $0 = function (e, t, a, n, i) {
      var l = Qt(e, t, a),
        u = l.metrics;
      e = l.value;
      var h;
      if (u) {
        var m = u.italic;
        (a === 'text' || (n && n.font === 'mathit')) && (m = 0),
          (h = new w0(e, u.height, u.depth, m, u.skew, u.width, i));
      } else
        typeof console < 'u' &&
          console.warn(
          ...
          (h = new w0(e, 0, 0, 0, 0, 0, i));
      if (n) {
        (h.maxFontSize = n.sizeMultiplier),
          n.style.isTight() && h.classes.push('mtight');
        var v = n.getColor();
        v && (h.style.color = v);
      }
      return h;
    ...
    Ps = function (e, t, a, n) {
      return (
        n === void 0 && (n = []),
        a.font === 'boldsymbol' && Qt(e, 'Main-Bold', t).metrics
          ? $0(e, 'Main-Bold', t, a, n.concat(['mathbf']))
          : e === '\\' || K[t][e].font === 'main'
            ? $0(e, 'Main-Regular', t, a, n)
            : $0(e, 'AMS-Regular', t, a, n.concat(['amsrm']))
      );
    },
    Ls = function (e, t, a, n, i) {
      return i !== 'textord' && Qt(e, 'Math-BoldItalic', t).metrics
    ...
    js = function (e, t, a) {
      var n = e.mode,
        ...
        h = u ? t.font : t.fontFamily,
        m = '',
        v = '';
      if ((i.charCodeAt(0) === 55349 && ([m, v] = Is(i, n)), m.length > 0))
        return $0(i, m, n, t, l.concat(v));
      if (h) {
        var g, b;
        if (h === 'boldsymbol') {
          var x = Ls(i, n, t, l, a);
          (g = x.fontName), (b = [x.fontClass]);
        } else
          u
            ? ((g = Yn[h].fontName), (b = [h]))
            : ((g = qt(h, t.fontWeight, t.fontShape)),
              (b = [h, t.fontWeight, t.fontShape]));
        if (Qt(i, g, n).metrics) return $0(i, g, n, t, l.concat(b));
        if (Gn.hasOwnProperty(i) && g.slice(0, 10) === 'Typewriter') {
          for (var k = [], A = 0; A < i.length; A++)
            k.push($0(i[A], g, n, t, l.concat(b)));
          return Wn(k);
        }
      }
      if (a === 'mathord')
        return $0(i, 'Math-Italic', n, t, l.concat(['mathnormal']));
      if (a === 'textord') {
        var C = K[n][i] && K[n][i].font;
        if (C === 'ams') {
          var B = qt('amsrm', t.fontWeight, t.fontShape);
          return $0(i, B, n, t, l.concat('amsrm', t.fontWeight, t.fontShape));
        } else if (C === 'main' || !C) {
          var R = qt('textrm', t.fontWeight, t.fontShape);
          return $0(i, R, n, t, l.concat(t.fontWeight, t.fontShape));
        } else {
          var q = qt(C, t.fontWeight, t.fontShape);
          return $0(i, q, n, t, l.concat(q, t.fontWeight, t.fontShape));
        }
      } else throw new Error('unexpected type: ' + a + ' in makeOrd');
    },
    Fs = (r, e) => {
      if (
        le(r.classes) !== le(e.classes) ||
        r.skew !== e.skew ||
    ...
    b0 = function (e, t, a, n) {
      var i = new we(e, t, a, n);
      return Qr(i), i;
    },
    Kn = (r, e, t, a) => new we(r, e, t, a),
    Vs = function (e, t, a) {
      var n = b0([e], [], t);
      return (
        (n.height = Math.max(
    ...
    Ks = function (e, t) {
      return e instanceof xe ? b0([], [e], t) : e;
    },
    Ws = function (e) {
      if (e.positionType === 'individualShift') {
        for (
          ...
          var u = -t[l].shift - i - t[l].elem.depth,
            h = u - (t[l - 1].elem.height + t[l - 1].elem.depth);
          (i = i + u), a.push({ type: 'kern', size: h }), a.push(t[l]);
        }
      ...
      if (e.positionType === 'top') {
        for (var v = e.positionData, g = 0; g < e.children.length; g++) {
          var b = e.children[g];
          v -= b.type === 'kern' ? b.size : b.elem.height + b.elem.depth;
        }
        m = v;
        ...
        if (e.positionType === 'shift') m = -x.elem.depth - e.positionData;
        else if (e.positionType === 'firstBaseline') m = -x.elem.depth;
        else throw new Error('Invalid positionType ' + e.positionType + '.');
      }
      return { children: e.children, depth: m };
    },
    Ys = function (e, t) {
      for (var { children: a, depth: n } = Ws(e), i = 0, l = 0; l < a.length; l++) {
        var u = a[l];
        if (u.type === 'elem') {
          var h = u.elem;
      ...
      var m = b0(['pstrut'], []);
      m.style.height = z(i);
      for (var v = [], g = n, b = n, x = n, k = 0; k < a.length; k++) {
        var A = a[k];
        if (A.type === 'kern') x += A.size;
        else {
          var C = A.elem,
            B = A.wrapperClasses || [],
            R = A.wrapperStyle || {},
            q = b0(B, [m, C], void 0, R);
          (q.style.top = z(-i - x - C.depth)),
            A.marginLeft && (q.style.marginLeft = A.marginLeft),
            A.marginRight && (q.style.marginRight = A.marginRight),
            v.push(q),
            (x += C.height + C.depth);
        }
        (g = Math.min(g, x)), (b = Math.max(b, x));
      }
      var j = b0(['vlist'], v);
      j.style.height = z(b);
      var I;
      if (g < 0) {
        var F = b0([], []),
          L = b0(['vlist'], [F]);
        L.style.height = z(-g);
        var Z = b0(['vlist-s'], [new w0('\u200B')]);
        I = [b0(['vlist-r'], [j, Z]), b0(['vlist-r'], [L])];
      } else I = [b0(['vlist-r'], [j])];
      var U = b0(['vlist-t'], I);
      return (
        I.length === 2 && U.classes.push('vlist-t2'),
        (U.height = b),
        (U.depth = -g),
        U
      );
    ...
    Zs = function (e, t) {
      var [a, n, i] = Xn[e],
        ...
        h = Kn(['overlay'], [u], t);
      return (h.height = i), (h.style.height = z(i)), (h.style.width = z(n)), h;
    },
    w = {
      fontMap: Yn,
      makeSymbol: $0,
    ...
    W0 = { number: 5, unit: 'mu' },
    Js = {
      mord: { mop: e0, mbin: ye, mrel: W0, minner: e0 },
      mop: { mord: e0, mop: e0, mrel: W0, minner: e0 },
      mbin: { mord: ye, mop: ye, mopen: ye, minner: ye },
      mrel: { mord: W0, mop: W0, mopen: W0, minner: W0 },
      mopen: {},
      mclose: { mop: e0, mbin: ye, mrel: W0, minner: e0 },
      mpunct: {
        mord: e0,
        mop: e0,
        mrel: W0,
  ...
  var Yt = function (e) {
    ...
    Z0 = w.makeSpan,
    e1 = ['leftmost', 'mbin', 'mopen', 'mrel', 'mop', 'mpunct'],
    t1 = ['rightmost', 'mrel', 'mclose', 'mpunct'],
    r1 = {
      display: O.DISPLAY,
      text: O.TEXT,
      script: O.SCRIPT,
    ...
    l0 = function (e, t, a, n) {
      ...
      if (e.length === 1) {
        var v = e[0];
        v.type === 'sizing'
          ? (m = t.havingSize(v.size))
          : v.type === 'styling' && (m = t.havingStyle(r1[v.style]));
      }
      var g = Z0([n[0] || 'leftmost'], [], t),
        b = Z0([n[1] || 'rightmost'], [], t),
        x = a === 'root';
      return (
        gn(
          i,
          (k, A) => {
            var C = A.classes[0],
              B = k.classes[0];
            C === 'mbin' && $.contains(t1, B)
              ? (A.classes[0] = 'mord')
              : B === 'mbin' && $.contains(e1, C) && (k.classes[0] = 'mord');
          },
          { node: g },
          b,
          x
        ...
        gn(
          ...
          (k, A) => {
            var C = Fr(A),
              B = Fr(k),
              R = C && B ? (k.hasClass('mtight') ? Qs[C][B] : Js[C][B]) : null;
            if (R) return w.makeGlue(R, m);
          },
          { node: g },
          b,
          x
    ...
    gn = function r(e, t, a, n, i) {
      ...
      for (var l = 0; l < e.length; l++) {
        ...
        m ? (a.node = u) : i && u.hasClass('newline') && (a.node = Z0(['leftmost'])),
          (a.insertAfter = ((g) => (b) => {
            e.splice(g + 1, 0, b), l++;
          })(l));
      }
    ...
    Jn = function (e) {
      return e instanceof xe ||
        e instanceof rt ||
        (e instanceof we && e.hasClass('enclosing'))
        ? e
        : null;
    },
    n1 = function r(e, t) {
    ...
    Fr = function (e, t) {
      return e ? (t && (e = n1(e, t)), a1[e.classes[0]] || null) : null;
    },
    nt = function (e, t) {
      var a = ['nulldelimiter'].concat(e.baseSizingClasses());
      return Z0(t.concat(a));
    },
    P = function (e, t, a) {
      if (!e) return Z0();
      if (Kt[e.type]) {
    ...
    for (var i = [], l = [], u = 0; u < a.length; u++)
      if (
        ...
        a[u].hasClass('newline') &&
          (l.pop(), l.length > 0 && (i.push(Ht(l, e)), (l = [])), i.push(a[u]));
    l.length > 0 && i.push(Ht(l, e));
    var m;
    t ? ((m = Ht(l0(t, e, !0))), (m.classes = ['tag']), i.push(m)) : n && i.push(n);
    var v = Z0(['katex-html'], i);
    if ((v.setAttribute('aria-hidden', 'true'), m)) {
      var g = m.children[0];
      (g.style.height = z(v.height + v.depth)),
        v.depth && (g.style.verticalAlign = z(-v.depth));
    }
    return v;
  }
  function Qn(r) {
  ...
  var x0 = class {
      ...
      toNode() {
        ...
        this.classes.length > 0 && (e.className = le(this.classes));
        for (var a = 0; a < this.children.length; a++)
      ...
      toMarkup() {
        ...
        this.classes.length > 0 &&
          (e += ' class ="' + $.escape(le(this.classes)) + '"'),
          (e += '>');
        for (var a = 0; a < this.children.length; a++)
          e += this.children[a].toMarkup();
    ...
    M = { MathNode: x0, TextNode: be, SpaceNode: Vr, newDocumentFragment: Qn },
    E0 = function (e, t, a) {
      return (
        K[t][e] &&
          K[t][e].replace &&
    ...
    ta = function (e, t) {
      ...
      var l = w.fontMap[a].fontName;
      return Jr(i, l, n) ? w.fontMap[a].variant : null;
    },
    k0 = function (e, t, a) {
      if (e.length === 1) {
        var n = V(e[0], t);
      ...
      for (var i = [], l, u = 0; u < e.length; u++) {
        var h = V(e[u], t);
        if (h instanceof x0 && l instanceof x0) {
          if (
            h.type === 'mtext' &&
            l.type === 'mtext' &&
            h.getAttribute('mathvariant') === l.getAttribute('mathvariant')
          ) {
            ...
            l.children.push(...h.children);
            continue;
          } else if (h.type === 'mi' && h.children.length === 1 && l.type === 'mn') {
            var m = h.children[0];
            if (m instanceof be && m.text === '.') {
              l.children.push(...h.children);
              continue;
            }
            ...
            if (
              v instanceof be &&
              v.text === '\u0338' &&
              (h.type === 'mo' || h.type === 'mi' || h.type === 'mn')
            ) {
              var g = h.children[0];
              g instanceof be &&
                g.text.length > 0 &&
                ((g.text = g.text.slice(0, 1) + '\u0338' + g.text.slice(1)),
                i.pop());
            }
          }
        }
  ...
  var ei = function (e) {
    ...
    i1 = function (e, t, a) {
      var n = ei(a),
        i;
      if (a.output === 'mathml') return yn(e, t, n, a.displayMode, !0);
      if (a.output === 'html') {
        var l = Ur(e, n);
        i = w.makeSpan(['katex'], [l]);
      } else {
        var u = yn(e, t, n, a.displayMode, !1),
          h = Ur(e, n);
        i = w.makeSpan(['katex'], [u, h]);
      }
      return ti(i, a);
    },
    s1 = function (e, t, a) {
    ...
    o1 = function (e) {
      var t = new M.MathNode('mo', [new M.TextNode(l1[e.replace(/^\\/, '')])]);
    ...
    c1 = function (e, t) {
      function a() {
        var u = 4e5,
          h = e.label.slice(1);
        if ($.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], h)) {
          var m = e,
            v = h1(m.base),
            g,
            b,
            x;
          if (v > 5)
            h === 'widehat' || h === 'widecheck'
              ? ((g = 420), (u = 2364), (x = 0.42), (b = h + '4'))
              : ((g = 312), (u = 2340), (x = 0.34), (b = 'tilde4'));
          else {
            var k = [1, 1, 2, 2, 3, 3][v];
            h === 'widehat' || h === 'widecheck'
              ? ((u = [0, 1062, 2364, 2364, 2364][k]),
                (g = [0, 239, 300, 360, 420][k]),
                (x = [0, 0.24, 0.3, 0.3, 0.36, 0.42][k]),
                (b = h + k))
              : ((u = [0, 600, 1033, 2339, 2340][k]),
                (g = [0, 260, 286, 306, 312][k]),
                (x = [0, 0.26, 0.286, 0.3, 0.306, 0.34][k]),
                (b = 'tilde' + k));
          }
          var A = new q0(b),
            C = new N0([A], {
          ...
          return { span: w.makeSvgSpan([], [C], t), minWidth: 0, height: x };
        } else {
          var B = [],
            R = u1[h],
            [q, j, I] = R,
          ...
          for (var m0 = 0; m0 < L; m0++) {
            var s0 = new q0(q[m0]),
              he = new N0([s0], {
                width: '400em',
                height: z(F),
                viewBox: '0 0 ' + u + ' ' + I,
                preserveAspectRatio: U[m0] + ' slice',
              }),
              v0 = w.makeSvgSpan([Z[m0]], [he], t);
            if (L === 1) return { span: v0, minWidth: j, height: F };
            (v0.style.height = z(F)), B.push(v0);
          }
          return { span: w.makeSpan(['stretchy'], B, t), minWidth: j, height: F };
        }
      }
    ...
    d1 = function (e, t, a, n, i) {
      ...
      if (/fbox|color|angl/.test(t)) {
        if (((l = w.makeSpan(['stretchy', t], [], i)), t === 'fbox')) {
        ...
        var v = new N0(m, { width: '100%', height: z(u) });
        l = w.makeSvgSpan([], [v], i);
      }
      return (l.height = u), (l.style.height = z(u)), l;
    },
    J0 = { encloseSpan: d1, mathMLnode: o1, svgSpan: c1 };
  function H(r, e) {
    if (!r || r.type !== e)
      throw new Error(
  ...
  var aa = (r, e) => {
      ...
      var i = P(t, e.havingCrampedStyle()),
        l = a.isShifty && $.isCharacterBox(t),
        u = 0;
      if (l) {
        var h = $.getBaseElem(t),
          m = P(h, e.havingCrampedStyle());
        u = mn(m).skew;
      }
      var v = a.label === '\\c',
        g = v ? i.height + i.depth : Math.min(i.height, e.fontMetrics().xHeight),
        b;
      if (a.isStretchy)
        (b = J0.svgSpan(a, e)),
          (b = w.makeVList(
        ...
        var x, k;
        a.label === '\\vec'
          ? ((x = w.staticSvg('vec', e)), (k = w.svgData.vec[1]))
          : ((x = w.makeOrd({ mode: a.mode, text: a.label }, e, 'textord')),
            (x = mn(x)),
            (x.italic = 0),
            (k = x.width),
            v && (g += x.depth)),
          (b = w.makeSpan(['accent-body'], [x]));
        var A = a.label === '\\textcircled';
        A && (b.classes.push('accent-full'), (g = i.height));
        var C = u;
        A || (C -= k / 2),
          (b.style.left = z(C)),
      ...
      var B = w.makeSpan(['mord', 'accent'], [b], e);
      return n
        ? ((n.children[0] = B),
    ...
    ri = (r, e) => {
      var t = r.isStretchy
          ? J0.mathMLnode(r.label)
          : new M.MathNode('mo', [E0(r.label, r.mode)]),
        a = new M.MathNode('mover', [V(r.base, e), t]);
  ...
  E({
    ...
    mathmlBuilder: (r, e) => {
      var t = J0.mathMLnode(r.label),
        a = new M.MathNode('munder', [V(r.base, e), t]);
  ...
  E({
    ...
    htmlBuilder(r, e) {
      var t = e.style,
        ...
        n = w.wrapFragment(P(r.body, a, e), e),
        i = r.label.slice(0, 2) === '\\x' ? 'x' : 'cd';
      n.classes.push(i + '-arrow-pad');
      var l;
      r.below &&
        ((a = e.havingStyle(t.sub())),
        (l = w.wrapFragment(P(r.below, a, e), e)),
        l.classes.push(i + '-arrow-pad'));
      var u = J0.svgSpan(r, e),
        h = -e.fontMetrics().axisHeight + 0.5 * u.height,
        m = -e.fontMetrics().axisHeight - 0.5 * u.height - 0.111;
      ...
      return (
        v.children[0].children[0].children[1].classes.push('svg-align'),
        w.makeSpan(['mrel', 'x-arrow'], [v], e)
      );
    },
    mathmlBuilder(r, e) {
      var t = J0.mathMLnode(r.label);
      ...
      if (r.body) {
        var n = It(V(r.body, e));
        if (r.below) {
          var i = It(V(r.below, e));
          a = new M.MathNode('munderover', [t, i, n]);
        } else a = new M.MathNode('mover', [t, n]);
      } else if (r.below) {
        var l = It(V(r.below, e));
        a = new M.MathNode('munder', [t, l]);
      } else (a = It()), (a = new M.MathNode('mover', [t, a]));
      return a;
    },
  });
  var f1 = w.makeSpan;
  ...
  E({
    ...
    handler(r, e) {
      ...
      return {
        ...
        mclass: l,
        body: [h],
        isCharacterBox: $.isCharacterBox(h),
      };
    },
    htmlBuilder: ai,
    mathmlBuilder: ni,
  ...
  E({
    ...
    handler(r, e) {
      var { parser: t } = r;
      return { type: 'pmb', mode: t.mode, mclass: tr(e[0]), body: n0(e[0]) };
    },
    htmlBuilder(r, e) {
      var t = l0(r.body, e, !0),
  ...
  var p1 = {
    ...
    xn = (r) => r.type === 'textord' && r.text === '@',
    v1 = (r, e) => (r.type === 'mathord' || r.type === 'atom') && r.text === e;
  function g1(r, e, t) {
    var a = p1[r];
    switch (a) {
      case '\\\\cdrightarrow':
      ...
      case '\\downarrow': {
        var n = t.callFunction('\\\\cdleft', [e[0]], []),
          ...
          h = { type: 'ordgroup', mode: 'math', body: [n, l, u] };
  ...
  function y1(r) {
    ...
    for (var a = [], n = [a], i = 0; i < e.length; i++) {
      for (var l = e[i], u = bn(), h = 0; h < l.length; h++)
        if (!xn(l[h])) u.body.push(l[h]);
        else {
          a.push(u), (h += 1);
          var m = ra(l[h]).text,
            v = new Array(2);
          if (
            ((v[0] = { type: 'ordgroup', mode: 'math', body: [] }),
            (v[1] = { type: 'ordgroup', mode: 'math', body: [] }),
            !('=|.'.indexOf(m) > -1))
          )
            if ('<>AV'.indexOf(m) > -1)
              for (var g = 0; g < 2; g++) {
                for (var b = !0, x = h + 1; x < l.length; x++) {
                  if (v1(l[x], m)) {
                    (b = !1), (h = x);
                    break;
                  }
            ...
            else throw new T('Expected one of "<>AV=|." after @', l[h]);
          var k = g1(m, v, r),
            A = { type: 'styling', body: [k], mode: 'math', style: 'display' };
          a.push(A), (u = bn());
        }
  ...
  E({
    ...
    htmlBuilder(r, e) {
      var t = e.havingStyle(e.style.sup()),
        a = w.wrapFragment(P(r.label, t, e), e);
      return (
    ...
    mathmlBuilder(r, e) {
      var t = new M.MathNode('mrow', [V(r.label, e)]);
      return (
  ...
  E({
    ...
    htmlBuilder(r, e) {
      var t = w.wrapFragment(P(r.fragment, e), e);
      return t.classes.push('cd-vert-arrow'), t;
    },
    mathmlBuilder(r, e) {
      return new M.MathNode('mrow', [V(r.fragment, e)]);
    },
  });
  E({
    type: 'textord',
    ...
    handler(r, e) {
      for (
        var { parser: t } = r, a = H(e[0], 'ordgroup'), n = a.body, i = '', l = 0;
        l < n.length;
        l++
      ) {
        var u = H(n[l], 'textord');
      ...
      var h = parseInt(i),
        m;
      if (isNaN(h)) throw new T('\\@char has non-numeric argument ' + i);
      if (h < 0 || h >= 1114111) throw new T('\\@char with invalid code point ' + i);
      return (
        h <= 65535
          ? (m = String.fromCharCode(h))
          : ((h -= 65536),
            (m = String.fromCharCode((h >> 10) + 55296, (h & 1023) + 56320))),
        { type: 'textord', mode: t.mode, text: m }
      );
    },
  });
  var ii = (r, e) => {
      var t = l0(r.body, e.withColor(r.color), !1);
      return w.makeFragment(t);
    },
    si = (r, e) => {
      var t = k0(r.body, e.withColor(r.color)),
        a = new M.MathNode('mstyle', t);
  ...
  E({
    ...
    handler(r, e) {
      var { parser: t } = r,
        ...
        n = e[1];
      return { type: 'color', mode: t.mode, color: a, body: n0(n) };
    },
    htmlBuilder: ii,
    mathmlBuilder: si,
  });
  ...
  E({
    ...
    handler(r, e, t) {
      ...
      return { type: 'cr', mode: a.mode, newLine: i, size: n && H(n, 'size').value };
    },
    htmlBuilder(r, e) {
      ...
      return (
        r.newLine &&
          ...
          r.size && (t.style.marginTop = z(t0(r.size, e)))),
        t
      );
    },
    mathmlBuilder(r, e) {
      ...
      return (
        r.newLine &&
          ...
          r.size && t.setAttribute('height', z(t0(r.size, e)))),
        t
      );
    },
  });
  ...
  E({
    ...
    handler(r) {
      ...
      if (Gr[a.text])
        return (
          (t === '\\global' || t === '\\\\globallong') && (a.text = Gr[a.text]),
  ...
  E({
    ...
    handler(r) {
      ...
      return (
        l && h.unshift(l),
        (t === '\\edef' || t === '\\xdef') &&
          ((h = e.gullet.expandTokens(h)), h.reverse()),
        e.gullet.macros.set(
          n,
          { tokens: h, numArgs: i, delimiters: u },
          t === Gr[t]
        ),
  ...
  E({
    ...
    handler(r) {
      var { parser: e, funcName: t } = r,
        a = li(e.gullet.popToken());
      e.gullet.consumeSpaces();
      var n = b1(e);
      return oi(e, a, n, t === '\\\\globallet'), { type: 'internal', mode: e.mode };
    },
  });
  E({
    type: 'internal',
  ...
  var Je = function (e, t, a) {
      var n = K.math[e] && K.math[e].replace,
        i = Jr(n || e, t, a);
      if (!i)
    ...
    na = function (e, t, a, n) {
      var i = a.havingBaseStyle(t),
        l = w.makeSpan(n.concat(i.sizingClasses(a)), [e], a),
    ...
    hi = function (e, t, a, n, i, l) {
      var u = w1(e, t, i, n),
        h = na(w.makeSpan(['delimsizing', 'size' + t], [u], n), O.TEXT, n, l);
      return a && ui(h, n, O.TEXT), h;
    },
    Br = function (e, t, a) {
      var n;
    ...
    Dr = function (e, t, a) {
      var n = _0['Size4-Regular'][e.charCodeAt(0)]
          ? _0['Size4-Regular'][e.charCodeAt(0)][4]
          : _0['Size1-Regular'][e.charCodeAt(0)][4],
        i = new q0('inner', Es(e, Math.round(1e3 * t))),
        l = new N0([i], {
          width: z(n),
          height: z(t),
          style: 'width:' + z(n),
    ...
    Kr = 0.008,
    Pt = { type: 'kern', size: -1 * Kr },
    k1 = ['|', '\\lvert', '\\rvert', '\\vert'],
    S1 = ['\\|', '\\lVert', '\\rVert', '\\Vert'],
    ci = function (e, t, a, n, i, l) {
      var u,
        h,
        m,
        v,
        ...
        : e === '\\Uparrow'
          ...
          : e === '\\downarrow'
            ...
            : e === '\\Downarrow'
              ? (u = m = '\u2016')
              : e === '\\updownarrow'
                ? ((u = '\\uparrow'), (m = '\u23D0'), (v = '\\downarrow'))
                : e === '\\Updownarrow'
                  ? ((u = '\\Uparrow'), (m = '\u2016'), (v = '\\Downarrow'))
                  : $.contains(k1, e)
                    ? ((m = '\u2223'), (g = 'vert'), (b = 333))
                    : $.contains(S1, e)
                      ? ((m = '\u2225'), (g = 'doublevert'), (b = 556))
                      : e === '[' || e === '\\lbrack'
                        ? ((u = '\u23A1'),
                          (m = '\u23A2'),
                          (v = '\u23A3'),
      ...
      if (h !== null) {
        var F = Je(h, x, i);
        (j = F.height + F.depth), (I = 2);
      }
      var L = A + q + j,
        Z = Math.max(0, Math.ceil((t - L) / (I * B))),
        U = L + Z * I * B,
        L0 = n.fontMetrics().axisHeight;
      a && (L0 *= n.sizeMultiplier);
      var m0 = U / 2 - L0,
        s0 = [];
      if (g.length > 0) {
        var he = U - A - q,
          v0 = Math.round(U * 1e3),
          B0 = Bs(g, Math.round(he * 1e3)),
          ee = new q0(g, B0),
          Se = (b / 1e3).toFixed(3) + 'em',
          Ae = (v0 / 1e3).toFixed(3) + 'em',
          nr = new N0([ee], {
            width: Se,
            height: Ae,
            viewBox: '0 0 ' + b + ' ' + v0,
          }),
          te = w.makeSvgSpan([], [nr], n);
        (te.height = v0 / 1e3),
          (te.style.width = Se),
          (te.style.height = Ae),
          s0.push({ type: 'elem', elem: te });
      } else {
        if ((s0.push(Br(v, x, i)), s0.push(Pt), h === null)) {
          var re = U - A - q + 2 * Kr;
          s0.push(Dr(m, re, n));
        } else {
          var T0 = (U - A - q - j) / 2 + 2 * Kr;
          s0.push(Dr(m, T0, n)),
            s0.push(Pt),
            s0.push(Br(h, x, i)),
            s0.push(Pt),
        ...
        s0.push(Pt), s0.push(Br(u, x, i));
      }
      var qe = n.havingBaseStyle(O.TEXT),
        ir = w.makeVList(
          { positionType: 'bottom', positionData: m0, children: s0 },
          qe
        );
      return na(w.makeSpan(['delimsizing', 'mult'], [ir], qe), O.TEXT, n, l);
    },
    $r = 80,
    Nr = 0.08,
    Or = function (e, t, a, n, i) {
      var l = Cs(e, n, a),
        u = new q0(e, l),
        h = new N0([u], {
          width: '400em',
      ...
      return w.makeSvgSpan(['hide-tail'], [h], i);
    },
    A1 = function (e, t) {
      var a = t.havingBaseSizing(),
        n = pi('\\surd', e * a.sizeMultiplier, fi, a),
        i = a.sizeMultiplier,
        ...
        n.type === 'small'
          ...
          : n.type === 'large'
            ? ((v = (1e3 + $r) * Qe[n.size]),
              (m = (Qe[n.size] + l) / i),
              (h = (Qe[n.size] + l + Nr) / i),
              (u = Or('sqrtSize' + n.size, h, v, l, t)),
              (u.style.minWidth = '1.02em'),
              (g = 1 / i))
            : ((h = e + l + Nr),
              (m = e + l),
              (v = Math.floor(1e3 * e + l) + $r),
              (u = Or('sqrtTall', h, v, l, t)),
    ...
    mi = ['<', '>', '\\langle', '\\rangle', '/', '\\backslash', '\\lt', '\\gt'],
    Qe = [0, 1.2, 1.8, 2.4, 3],
    T1 = function (e, t, a, n, i) {
      if (
        (e === '<' || e === '\\lt' || e === '\u27E8'
          ? (e = '\\langle')
          : (e === '>' || e === '\\gt' || e === '\u27E9') && (e = '\\rangle'),
        $.contains(di, e) || $.contains(mi, e))
      )
        return hi(e, t, !1, a, n, i);
      if ($.contains(M1, e)) return ci(e, Qe[t], !1, a, n, i);
    ...
    pi = function (e, t, a, n) {
      for (
        var i = Math.min(2, 3 - n.style.size), l = i;
        l < a.length && a[l].type !== 'stack';
        l++
      ) {
        var u = Je(e, E1(a[l]), 'math'),
          h = u.height + u.depth;
        if (a[l].type === 'small') {
    ...
    vi = function (e, t, a, n, i, l) {
      e === '<' || e === '\\lt' || e === '\u27E8'
        ? (e = '\\langle')
        : (e === '>' || e === '\\gt' || e === '\u27E9') && (e = '\\rangle');
      var u;
      $.contains(mi, e) ? (u = z1) : $.contains(di, e) ? (u = fi) : (u = C1);
      var h = pi(e, t, u, n);
      return h.type === 'small'
        ? x1(e, h.style, a, n, i, l)
        : h.type === 'large'
          ? hi(e, h.size, a, n, i, l)
          : ci(e, t, a, n, i, l);
    },
    B1 = function (e, t, a, n, i, l) {
      var u = n.fontMetrics().axisHeight * n.sizeMultiplier,
        ...
        v = Math.max(t - u, a + u),
        g = Math.max((v / 500) * h, 2 * v - m);
      return vi(e, g, !0, n, i, l);
    },
    X0 = {
      sqrtImage: A1,
      sizedDelim: T1,
  ...
  function rr(r, e) {
    var t = er(r);
    if (t && $.contains(D1, t.text)) return t;
    throw t
  ...
  E({
    ...
    handler: (r, e) => {
      ...
      return {
        type: 'delimsizing',
        mode: r.parser.mode,
        size: wn[r.funcName].size,
        mclass: wn[r.funcName].mclass,
        delim: t.text,
      };
    },
    htmlBuilder: (r, e) =>
      r.delim === '.'
        ? w.makeSpan([r.mclass])
        : X0.sizedDelim(r.delim, r.size, e, r.mode, [r.mclass]),
    mathmlBuilder: (r) => {
      var e = [];
      r.delim !== '.' && e.push(E0(r.delim, r.mode));
      var t = new M.MathNode('mo', e);
      r.mclass === 'mopen' || r.mclass === 'mclose'
        ? t.setAttribute('fence', 'true')
        : t.setAttribute('fence', 'false'),
        t.setAttribute('stretchy', 'true');
      var a = z(X0.sizeToMaxHeight[r.size]);
  ...
  E({
    ...
    htmlBuilder: (r, e) => {
      kn(r);
      for (
        var t = l0(r.body, e, !0, ['mopen', 'mclose']), a = 0, n = 0, i = !1, l = 0;
        l < t.length;
        l++
      )
        t[l].isMiddle
          ? (i = !0)
          : ((a = Math.max(t[l].height, a)), (n = Math.max(t[l].depth, n)));
      (a *= e.sizeMultiplier), (n *= e.sizeMultiplier);
      var u;
      if (
        (r.left === '.'
          ? (u = nt(e, ['mopen']))
          : (u = X0.leftRightDelim(r.left, a, n, e, r.mode, ['mopen'])),
        t.unshift(u),
        i)
      )
        for (var h = 1; h < t.length; h++) {
          var m = t[h],
            v = m.isMiddle;
          v && (t[h] = X0.leftRightDelim(v.delim, a, n, v.options, r.mode, []));
        }
      var g;
      if (r.right === '.') g = nt(e, ['mclose']);
      else {
        var b = r.rightColor ? e.withColor(r.rightColor) : e;
        g = X0.leftRightDelim(r.right, a, n, b, r.mode, ['mclose']);
      }
    ...
    mathmlBuilder: (r, e) => {
      ...
      var t = k0(r.body, e);
      if (r.left !== '.') {
        var a = new M.MathNode('mo', [E0(r.left, r.mode)]);
        a.setAttribute('fence', 'true'), t.unshift(a);
      }
      if (r.right !== '.') {
        var n = new M.MathNode('mo', [E0(r.right, r.mode)]);
  ...
  var ia = (r, e) => {
      var t = w.wrapFragment(P(r.body, e), e),
        a = r.label.slice(1),
        n = e.sizeMultiplier,
        i,
        l = 0,
        u = $.isCharacterBox(r.body);
      if (a === 'sout')
        (i = w.makeSpan(['stretchy', 'sout'])),
          (i.height = e.fontMetrics().defaultRuleThickness / n),
          (l = -0.5 * e.fontMetrics().xHeight);
      else if (a === 'phase') {
        var h = t0({ number: 0.6, unit: 'pt' }, e),
          m = t0({ number: 0.35, unit: 'ex' }, e),
          v = e.havingBaseSizing();
        n = n / v.sizeMultiplier;
        var g = t.height + t.depth + h + m;
        t.style.paddingLeft = z(g / 2 + h);
        var b = Math.floor(1e3 * g * n),
          x = Ts(b),
          k = new N0([new q0('phase', x)], {
            width: '400em',
            height: z(b / 1e3),
            viewBox: '0 0 400000 ' + b,
            preserveAspectRatio: 'xMinYMin slice',
          });
        (i = w.makeSvgSpan(['hide-tail'], [k], e)),
          (i.style.height = z(g)),
          (l = t.depth + h + m);
      } else {
        /cancel/.test(a)
        ...
        /box/.test(a)
          ? ((B = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
            (A = e.fontMetrics().fboxsep + (a === 'colorbox' ? 0 : B)),
            (C = A))
          : a === 'angl'
            ? ((B = Math.max(
            ...
            : ((A = u ? 0.2 : 0), (C = A)),
          (i = J0.encloseSpan(t, a, A, C, e)),
          /fbox|boxed|fcolorbox/.test(a)
            ? ((i.style.borderStyle = 'solid'), (i.style.borderWidth = z(B)))
            : a === 'angl' &&
              B !== 0.049 &&
              ((i.style.borderTopWidth = z(B)), (i.style.borderRightWidth = z(B))),
          (l = t.depth + C),
          r.backgroundColor &&
  ...
  function ue(r, e, t) {
    ...
    if (
      ...
      if (x == null) l = 1;
        ...
        throw new T('Invalid \\arraystretch: ' + x);
    }
    r.gullet.beginGroup();
    var k = [],
      A = [k],
    ...
    function j() {
      R &&
        (r.gullet.macros.get('\\df@tag')
          ? (R.push(r.subparse([new C0('\\df@tag')])),
            r.gullet.macros.set('\\df@tag', void 0, !0))
          : R.push(!!h && r.gullet.macros.get('\\@eqnsw') === '1'));
    }
    for (q(), B.push(Sn(r)); ; ) {
      var I = r.parseExpression(!1, m ? '\\end' : '\\\\');
      r.gullet.endGroup(),
        r.gullet.beginGroup(),
        (I = { type: 'ordgroup', mode: r.mode, body: I }),
        t && (I = { type: 'styling', mode: r.mode, style: t, body: [I] }),
        k.push(I);
      var F = r.fetch().text;
      if (F === '&') {
        if (g && k.length === g) {
          if (m || u) throw new T('Too many tab characters: &', r.nextToken);
        ...
        j(),
          k.length === 1 &&
            ...
            (A.length > 1 || !v) &&
            A.pop(),
          B.length < A.length + 1 && B.push([]);
        break;
      } else if (F === '\\\\') {
        r.consume();
        var L = void 0;
        r.gullet.future().text !== ' ' && (L = r.parseSizeGroup(!0)),
          C.push(L ? L.value : null),
          j(),
          B.push(Sn(r)),
          (k = []),
          A.push(k),
  ...
  var I0 = function (e, t) {
      ...
      if (e.colSeparationType && e.colSeparationType === 'small') {
        var x = t.havingStyle(O.SCRIPT).sizeMultiplier;
        b = 0.2778 * (x / t.sizeMultiplier);
      }
      var k =
          e.colSeparationType === 'CD' ? t0({ number: 3, unit: 'ex' }, t) : 12 * g,
        A = 3 * g,
        C = e.arraystretch * k,
        B = 0.7 * C,
        R = 0.3 * C,
      ...
      function j(ot) {
        for (var ut = 0; ut < ot.length; ++ut)
          ut > 0 && (q += 0.25), m.push({ pos: q, isDashed: ot[ut] });
      }
      for (j(l[0]), a = 0; a < e.body.length; ++a) {
        ...
        for (n = 0; n < I.length; ++n) {
          var U = P(I[n], t);
          L < U.depth && (L = U.depth), F < U.height && (F = U.height), (Z[n] = U);
        }
        var L0 = e.rowGaps[a],
          m0 = 0;
        L0 &&
          ((m0 = t0(L0, t)), m0 > 0 && ((m0 += R), L < m0 && (L = m0), (m0 = 0))),
          e.addJot && (L += A),
          (Z.height = F),
          (Z.depth = L),
          (q += F),
      ...
      var s0 = q / 2 + t.fontMetrics().axisHeight,
        he = e.cols || [],
        v0 = [],
        B0,
        ee,
      ...
      if (e.tags && e.tags.some((ot) => ot))
        for (a = 0; a < i; ++a) {
          var Ae = h[a],
            ...
            re = void 0;
          te === !0
            ? (re = w.makeSpan(['eqn-num'], [], t))
            : te === !1
              ? (re = w.makeSpan([], [], t))
              : (re = w.makeSpan([], l0(te, t, !0), t)),
            (re.depth = Ae.depth),
            (re.height = Ae.height),
            Se.push({ type: 'elem', elem: re, shift: nr });
        }
      for (n = 0, ee = 0; n < u || ee < he.length; ++n, ++ee) {
        for (var T0 = he[ee] || {}, qe = !0; T0.type === 'separator'; ) {
          if (
            (qe ||
              ((B0 = w.makeSpan(['arraycolsep'], [])),
              (B0.style.width = z(t.fontMetrics().doubleRuleSep)),
              v0.push(B0)),
            T0.separator === '|' || T0.separator === ':')
          ) {
            var ir = T0.separator === '|' ? 'solid' : 'dashed',
              Me = w.makeSpan(['vertical-separator'], [], t);
            (Me.style.height = z(q)),
              (Me.style.borderRightWidth = z(v)),
              (Me.style.borderRightStyle = ir),
              (Me.style.margin = '0 ' + z(-v / 2));
            var va = q - s0;
            va && (Me.style.verticalAlign = z(-va)), v0.push(Me);
          } else throw new T('Invalid separator type: ' + T0.separator);
          ee++, (T0 = he[ee] || {}), (qe = !1);
        }
        if (!(n >= u)) {
          var Te = void 0;
          (n > 0 || e.hskipBeforeAndAfter) &&
            ((Te = $.deflt(T0.pregap, b)),
            Te !== 0 &&
              ((B0 = w.makeSpan(['arraycolsep'], [])),
              (B0.style.width = z(Te)),
              v0.push(B0)));
          ...
          for (a = 0; a < i; ++a) {
            ...
            if (lt) {
              ...
              (lt.depth = st.depth),
                (lt.height = st.height),
                ze.push({ type: 'elem', elem: lt, shift: _i });
            }
          }
          (ze = w.makeVList({ positionType: 'individualShift', children: ze }, t)),
            (ze = w.makeSpan(['col-align-' + (T0.align || 'c')], [ze])),
            v0.push(ze),
            (n < u - 1 || e.hskipBeforeAndAfter) &&
              ((Te = $.deflt(T0.postgap, b)),
              Te !== 0 &&
                ((B0 = w.makeSpan(['arraycolsep'], [])),
                (B0.style.width = z(Te)),
                v0.push(B0)));
      ...
      if (((h = w.makeSpan(['mtable'], v0)), m.length > 0)) {
        for (
          var qi = w.makeLineSpan('hline', t, v),
            Hi = w.makeLineSpan('hdashline', t, v),
            sr = [{ type: 'elem', elem: h, shift: 0 }];
          m.length > 0;
          ...
          var ga = m.pop(),
            ya = ga.pos - s0;
          ga.isDashed
            ? sr.push({ type: 'elem', elem: Hi, shift: ya })
            : sr.push({ type: 'elem', elem: qi, shift: ya });
        }
        h = w.makeVList({ positionType: 'individualShift', children: sr }, t);
      }
      if (Se.length === 0) return w.makeSpan(['mord'], [h], t);
      var lr = w.makeVList({ positionType: 'individualShift', children: Se }, t);
      return (lr = w.makeSpan(['tag'], [lr], t)), w.makeFragment([h, lr]);
    },
    ...
    P0 = function (e, t) {
      for (
        ...
        for (var u = e.body[l], h = [], m = 0; m < u.length; m++)
          h.push(new M.MathNode('mtd', [V(u[m], t)]));
        e.tags &&
          e.tags[l] &&
          (h.unshift(n), h.push(n), e.leqno ? h.unshift(i) : h.push(i)),
          a.push(new M.MathNode('mtr', h));
      }
      var v = new M.MathNode('mtable', a),
        g =
          e.arraystretch === 0.5
            ? 0.1
            : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
      v.setAttribute('rowspacing', z(g));
      var b = '',
        x = '';
      if (e.cols && e.cols.length > 0) {
        var k = e.cols,
          ...
          B = 0,
          R = k.length;
        k[0].type === 'separator' && ((b += 'top '), (B = 1)),
          k[k.length - 1].type === 'separator' && ((b += 'bottom '), (R -= 1));
        for (var q = B; q < R; q++)
          k[q].type === 'align'
            ? ((x += $1[k[q].align]), C && (A += 'none '), (C = !0))
            : k[q].type === 'separator' &&
              C &&
              ((A += k[q].separator === '|' ? 'solid ' : 'dashed '), (C = !1));
        v.setAttribute('columnalign', x.trim()),
          /[sd]/.test(A) && v.setAttribute('columnlines', A.trim());
      }
      if (e.colSeparationType === 'align') {
        for (var j = e.cols || [], I = '', F = 1; F < j.length; F++)
          I += F % 2 ? '0em ' : '1em ';
        v.setAttribute('columnspacing', I.trim());
      } else
        e.colSeparationType === 'alignat' || e.colSeparationType === 'gather'
          ? v.setAttribute('columnspacing', '0em')
          : e.colSeparationType === 'small'
            ? v.setAttribute('columnspacing', '0.2778em')
            : e.colSeparationType === 'CD'
              ? v.setAttribute('columnspacing', '0.5em')
              : v.setAttribute('columnspacing', '1em');
      var L = '',
        Z = e.hLinesBeforeRow;
      (b += Z[0].length > 0 ? 'left ' : ''),
        (b += Z[Z.length - 1].length > 0 ? 'right ' : '');
      for (var U = 1; U < Z.length - 1; U++)
        L += Z[U].length === 0 ? 'none ' : Z[U][0] ? 'dashed ' : 'solid ';
      return (
        /[sd]/.test(L) && v.setAttribute('rowlines', L.trim()),
        b !== '' &&
          ((v = new M.MathNode('menclose', [v])),
          v.setAttribute('notation', b.trim())),
        e.arraystretch &&
          e.arraystretch < 1 &&
          ((v = new M.MathNode('mstyle', [v])), v.setAttribute('scriptlevel', '1')),
        v
      );
    },
    bi = function (e, t) {
      ...
      l.body.forEach(function (B) {
        for (var R = 1; R < B.length; R += 2) {
          var q = H(B[R], 'styling'),
            j = H(q.body[0], 'ordgroup');
          j.body.unshift(m);
        }
        if (x) h < B.length && (h = B.length);
        else {
          var I = B.length / 2;
          if (u < I)
            throw new T(
              'Too many math in a row: ' + ('expected ' + u + ', but got ' + I),
              B[0]
            );
        }
      });
      for (var k = 0; k < h; ++k) {
        var A = 'r',
          C = 0;
        k % 2 === 1 ? (A = 'l') : k > 0 && x && (C = 1),
          (a[k] = { type: 'align', align: A, pregap: C, postgap: 0 });
      }
    ...
    handler(r, e) {
      var t = er(e[0]),
        ...
        n = a.map(function (l) {
          var u = ra(l),
            h = u.text;
          if ('lcr'.indexOf(h) !== -1) return { type: 'align', align: h };
          if (h === '|') return { type: 'separator', separator: '|' };
          if (h === ':') return { type: 'separator', separator: ':' };
          throw new T('Unknown column alignment: ' + h, l);
        }),
        i = { cols: n, hskipBeforeAndAfter: !0, maxNumCols: n.length };
      return ue(r.parser, i, oa(r.envName));
    },
    htmlBuilder: I0,
    mathmlBuilder: P0,
  });
  H0({
    ...
    handler(r) {
      ...
      var i = ue(r.parser, a, oa(r.envName)),
  ...
  H0({
    ...
    props: { numArgs: 0 },
    handler(r) {
      $.contains(['gather', 'gather*'], r.envName) && ar(r);
      var e = {
        cols: [{ type: 'align', align: 'c' }],
        addJot: !0,
        colSeparationType: 'gather',
        autoTag: la(r.envName),
        emptySingleRow: !0,
        leqno: r.parser.settings.leqno,
      };
      return ue(r.parser, e, 'display');
    },
    htmlBuilder: I0,
    mathmlBuilder: P0,
  });
  ...
  E({
    ...
    handler(r, e) {
      ...
      for (var i = '', l = 0; l < n.body.length; ++l)
        i += H(n.body[l], 'textord').text;
      if (a === '\\begin') {
        if (!An.hasOwnProperty(i)) throw new T('No such environment: ' + i, n);
        var u = An[i],
          { args: h, optArgs: m } = t.parseArguments('\\begin{' + i + '}', u),
          v = { mode: t.mode, envName: i, parser: t },
          g = u.handler(v, h, m);
        t.expect('\\end', !1);
        var b = t.nextToken,
        ...
        if (x.name !== i)
          throw new T(
            'Mismatch: \\begin{' + i + '} matched by \\end{' + x.name + '}',
            b
          );
        return g;
      }
  ...
  var ki = (r, e) => {
    ...
    ua = (r, e) => {
      ...
      if (r.continued) {
        ...
        (l.height = l.height < u ? u : l.height),
          (l.depth = l.depth < h ? h : l.depth);
      }
      i = e.havingStyle(n);
      var m = P(r.denom, i, e),
        v,
      ...
      r.hasBarLine
        ? (r.barSize
            ? ((g = t0(r.barSize, e)), (v = w.makeLineSpan('frac-line', e, g)))
            : (v = w.makeLineSpan('frac-line', e)),
          (g = v.height),
          (b = v.height))
        : ((v = null), (g = 0), (b = e.fontMetrics().defaultRuleThickness));
      var x, k, A;
      t.size === O.DISPLAY.size || r.size === 'display'
        ? ((x = e.fontMetrics().num1),
          g > 0 ? (k = 3 * b) : (k = 7 * b),
          (A = e.fontMetrics().denom1))
        : (g > 0
            ? ((x = e.fontMetrics().num2), (k = b))
            : ((x = e.fontMetrics().num3), (k = 3 * b)),
          (A = e.fontMetrics().denom2));
      var C;
      if (v) {
        var R = e.fontMetrics().axisHeight;
        x - l.depth - (R + 0.5 * g) < k && (x += k - (x - l.depth - (R + 0.5 * g))),
          R - 0.5 * g - (m.height - A) < k &&
            (A += k - (R - 0.5 * g - (m.height - A)));
        var q = -(R - 0.5 * g);
        C = w.makeVList(
          {
            positionType: 'individualShift',
            children: [
              { type: 'elem', elem: m, shift: A },
              { type: 'elem', elem: v, shift: q },
        ...
        var B = x - l.depth - (m.height - A);
        B < k && ((x += 0.5 * (k - B)), (A += 0.5 * (k - B))),
          (C = w.makeVList(
            {
              positionType: 'individualShift',
              children: [
      ...
      t.size === O.DISPLAY.size
        ? (j = e.fontMetrics().delim1)
        : t.size === O.SCRIPTSCRIPT.size
          ? (j = e.havingStyle(O.SCRIPT).fontMetrics().delim2)
          : (j = e.fontMetrics().delim2);
      var I, F;
      return (
        r.leftDelim == null
          ? (I = nt(e, ['mopen']))
          : (I = X0.customSizedDelim(r.leftDelim, j, !0, e.havingStyle(t), r.mode, [
              'mopen',
            ])),
        r.continued
          ? (F = w.makeSpan([]))
        ...
        w.makeSpan(
          ...
          [I, w.makeSpan(['mfrac'], [C]), F],
          e
        )
      );
    },
    ha = (r, e) => {
      var t = new M.MathNode('mfrac', [V(r.numer, e), V(r.denom, e)]);
      if (!r.hasBarLine) t.setAttribute('linethickness', '0px');
      else if (r.barSize) {
        var a = t0(r.barSize, e);
        t.setAttribute('linethickness', z(a));
      }
      var n = ki(r.size, e.style);
      if (n.size !== e.style.size) {
        t = new M.MathNode('mstyle', [t]);
        var i = n.size === O.DISPLAY.size ? 'true' : 'false';
      ...
      if (r.leftDelim != null || r.rightDelim != null) {
        ...
        if ((l.push(t), r.rightDelim != null)) {
          ...
          h.setAttribute('fence', 'true'), l.push(h);
        }
        return ea(l);
      }
      return t;
  ...
  E({
    ...
    handler(r, e) {
      var { parser: t } = r,
        ...
        n = e[5],
        i = Yt(e[0]),
        l = i.type === 'atom' && i.family === 'open' ? zn(i.text) : null,
        u = Yt(e[1]),
        h = u.type === 'atom' && u.family === 'close' ? zn(u.text) : null,
        m = H(e[2], 'size'),
        v,
        g = null;
      m.isBlank ? (v = !0) : ((g = m.value), (v = g.number > 0));
      var b = 'auto',
        x = e[3];
      if (x.type === 'ordgroup') {
        if (x.body.length > 0) {
          var k = H(x.body[0], 'textord');
          b = Tn[Number(k.text)];
        }
      } else (x = H(x, 'textord')), (b = Tn[Number(x.text)]);
      return {
        type: 'genfrac',
        mode: t.mode,
        numer: a,
  ...
  var Si = (r, e) => {
      ...
      r.type === 'supsub'
        ...
        : (n = H(r, 'horizBrace'));
      var i = P(n.base, e.havingBaseStyle(O.DISPLAY)),
        l = J0.svgSpan(n, e),
        u;
      if (
        (n.isOver
        ...
        var h = w.makeSpan(['mord', n.isOver ? 'mover' : 'munder'], [u], e);
        n.isOver
          ? (u = w.makeVList(
              {
                positionType: 'firstBaseline',
    ...
    N1 = (r, e) => {
      var t = J0.mathMLnode(r.label);
      return new M.MathNode(r.isOver ? 'mover' : 'munder', [V(r.base, e), t]);
    };
  E({
    type: 'horizBrace',
  ...
  E({
    ...
    handler: (r, e) => {
      ...
      return t.settings.isTrusted({ command: '\\href', url: n })
        ? { type: 'href', mode: t.mode, href: n, body: n0(a) }
    ...
    mathmlBuilder: (r, e) => {
      var t = oe(r.body, e);
      return (
        t instanceof x0 || (t = new x0('mrow', [t])),
  ...
  E({
    ...
    handler: (r, e) => {
      ...
      for (var n = [], i = 0; i < a.length; i++) {
        var l = a[i];
        l === '~' && (l = '\\textasciitilde'),
          n.push({ type: 'textord', mode: 'text', text: l });
      }
      var u = { type: 'text', mode: t.mode, font: '\\texttt', body: n };
      return { type: 'href', mode: t.mode, href: a, body: n0(u) };
    },
  });
  E({
    type: 'hbox',
    ...
    handler(r, e) {
      var { parser: t } = r;
      return { type: 'hbox', mode: t.mode, body: n0(e[0]) };
    },
    htmlBuilder(r, e) {
      var t = l0(r.body, e, !1);
      return w.makeFragment(t);
    ...
    mathmlBuilder(r, e) {
      return new M.MathNode('mrow', k0(r.body, e));
    },
  });
  E({
    type: 'html',
    ...
    handler: (r, e) => {
      ...
      switch (a) {
        case '\\htmlClass':
          (h.class = i), (u = { command: '\\htmlClass', class: i });
          break;
        case '\\htmlId':
          (h.id = i), (u = { command: '\\htmlId', id: i });
          break;
        case '\\htmlStyle':
          (h.style = i), (u = { command: '\\htmlStyle', style: i });
          break;
        case '\\htmlData': {
          for (var m = i.split(','), v = 0; v < m.length; v++) {
            var g = m[v].split('=');
            if (g.length !== 2)
              throw new T('Error parsing key-value for \\htmlData');
            h['data-' + g[0].trim()] = g[1].trim();
          }
          u = { command: '\\htmlData', attributes: h };
          break;
        }
        default:
      ...
      return t.settings.isTrusted(u)
        ? { type: 'html', mode: t.mode, attributes: h, body: n0(l) }
  ...
  E({
    ...
    handler: (r, e) => {
      var { parser: t } = r;
      return { type: 'htmlmathml', mode: t.mode, html: n0(e[0]), mathml: n0(e[1]) };
    },
    htmlBuilder: (r, e) => {
      var t = l0(r.html, e, !1);
      return w.makeFragment(t);
    },
    mathmlBuilder: (r, e) => oe(r.mathml, e),
  });
  var Rr = function (e) {
    ...
    if (!jn(a)) throw new T("Invalid unit: '" + a.unit + "' in \\includegraphics.");
    return a;
  };
  E({
    ...
    handler: (r, e, t) => {
      ...
      if (t[0])
        for (
          var h = H(t[0], 'raw').string, m = h.split(','), v = 0;
          v < m.length;
          v++
        ) {
          var g = m[v].split('=');
    ...
    htmlBuilder: (r, e) => {
      var t = t0(r.height, e),
        a = 0;
      r.totalheight.number > 0 && (a = t0(r.totalheight, e) - t);
      var n = 0;
      r.width.number > 0 && (n = t0(r.width, e));
      var i = { height: z(t + a) };
      n > 0 && (i.width = z(n)), a > 0 && (i.verticalAlign = z(-a));
      var l = new Lr(r.src, r.alt, i);
    ...
    mathmlBuilder: (r, e) => {
      ...
      if (
        (r.totalheight.number > 0 &&
          ((n = t0(r.totalheight, e) - a), t.setAttribute('valign', z(-n))),
  ...
  E({
    ...
    htmlBuilder: (r, e) => {
      var t;
      r.alignment === 'clap'
        ? ((t = w.makeSpan([], [P(r.body, e)])), (t = w.makeSpan(['inner'], [t], e)))
        : (t = w.makeSpan(['inner'], [P(r.body, e)]));
    ...
    mathmlBuilder: (r, e) => {
      var t = new M.MathNode('mpadded', [V(r.body, e)]);
      if (r.alignment !== 'rlap') {
  ...
  var Ai = (r, e, t, a, n, i, l) => {
      r = w.makeSpan([], [r]);
      var u = t && $.isCharacterBox(t),
        h,
        m;
      if (e) {
        var v = P(e, a.havingStyle(n.sup()), a);
        m = {
          elem: v,
          kern: Math.max(
      ...
      if (t) {
        var g = P(t, a.havingStyle(n.sub()), a);
        h = {
          elem: g,
          kern: Math.max(
        ...
        b = w.makeVList(
          {
            ...
            children: [
              ...
              { type: 'elem', elem: h.elem, marginLeft: z(-i) },
              { type: 'kern', size: h.kern },
              { type: 'elem', elem: r },
              { type: 'kern', size: m.kern },
              { type: 'elem', elem: m.elem, marginLeft: z(i) },
              { type: 'kern', size: a.fontMetrics().bigOpSpacing5 },
            ],
          },
          a
    ...
    _e = (r, e) => {
      ...
      var l = e.style,
        u = !1;
      l.size === O.DISPLAY.size && i.symbol && !$.contains(Mi, i.name) && (u = !0);
      var h;
      if (i.symbol) {
        var m = u ? 'Size2-Regular' : 'Size1-Regular',
          v = '';
        if (
          ((i.name === '\\oiint' || i.name === '\\oiiint') &&
            ((v = i.name.slice(1)), (i.name = v === 'oiint' ? '\\iint' : '\\iiint')),
          (h = w.makeSymbol(i.name, m, 'math', e, [
            'mop',
            'op-symbol',
            u ? 'large-op' : 'small-op',
          ])),
          ...
          var g = h.italic,
            b = w.staticSvg(v + 'Size' + (u ? '2' : '1'), e);
          (h = w.makeVList(
            {
              positionType: 'individualShift',
              children: [
                { type: 'elem', elem: h, shift: 0 },
                { type: 'elem', elem: b, shift: u ? 0.08 : 0 },
              ],
            },
            e
          )),
        ...
        var x = l0(i.body, e, !0);
        x.length === 1 && x[0] instanceof w0
          ? ((h = x[0]), (h.classes[0] = 'mop'))
          : (h = w.makeSpan(['mop'], x, e));
      } else {
        for (var k = [], A = 1; A < i.name.length; A++)
          k.push(w.mathsym(i.name[A], i.mode, e));
        h = w.makeSpan(['mop'], k, e);
      }
      var C = 0,
        B = 0;
      return (
        (h instanceof w0 || i.name === '\\oiint' || i.name === '\\oiiint') &&
          !i.suppressBaseShift &&
          ((C = (h.height - h.depth) / 2 - e.fontMetrics().axisHeight),
          (B = h.italic)),
        n
          ? Ai(h, t, a, e, l, B, C)
          : (C && ((h.style.position = 'relative'), (h.style.top = z(C))), h)
      );
    },
    it = (r, e) => {
      var t;
      if (r.symbol)
        (t = new x0('mo', [E0(r.name, r.mode)])),
          $.contains(Mi, r.name) && t.setAttribute('largeop', 'false');
      else if (r.body) t = new x0('mo', k0(r.body, e));
      else {
        t = new x0('mi', [new be(r.name.slice(1))]);
        var a = new x0('mo', [E0('\u2061', 'text')]);
        r.parentIsSupSub ? (t = new x0('mrow', [t, a])) : (t = Qn([t, a]));
      }
      return t;
    },
    O1 = {
  ...
  var Ti = (r, e) => {
      ...
      if (i.body.length > 0) {
        for (
          var u = i.body.map((g) => {
              ...
              return typeof b == 'string'
                ? { type: 'textord', mode: g.mode, text: b }
                : g;
            }),
            h = l0(u, e.withFont('mathrm'), !0),
            m = 0;
          m < h.length;
          m++
        ) {
        ...
        l = w.makeSpan(['mop'], h, e);
      } else l = w.makeSpan(['mop'], [], e);
      return n ? Ai(l, t, a, e, e.style, 0, 0) : l;
    },
    _1 = (r, e) => {
      for (
        var t = k0(r.body, e.withFont('mathrm')), a = !0, n = 0;
        n < t.length;
        n++
      ) {
        var i = t[n];
        if (!(i instanceof M.SpaceNode))
          if (i instanceof M.MathNode)
            switch (i.type) {
              ...
              case 'mo': {
                var l = i.children[0];
                i.children.length === 1 && l instanceof M.TextNode
      ...
      var h = new M.MathNode('mi', t);
      h.setAttribute('mathvariant', 'normal');
      var m = new M.MathNode('mo', [E0('\u2061', 'text')]);
      return r.parentIsSupSub
        ? new M.MathNode('mrow', [h, m])
        : M.newDocumentFragment([h, m]);
    };
  E({
    type: 'operatorname',
  ...
  ke({
    ...
    htmlBuilder(r, e) {
      return r.semisimple
        ? w.makeFragment(l0(r.body, e, !1))
        : w.makeSpan(['mord'], l0(r.body, e, !0), e);
    },
    mathmlBuilder(r, e) {
      return oe(r.body, e, !0);
    },
  });
  E({
    type: 'overline',
    ...
    mathmlBuilder(r, e) {
      ...
      t.setAttribute('stretchy', 'true');
      var a = new M.MathNode('mover', [V(r.body, e), t]);
      return a.setAttribute('accent', 'true'), a;
    },
  });
  E({
    ...
    handler: (r, e) => {
      var { parser: t } = r,
        a = e[0];
      return { type: 'phantom', mode: t.mode, body: n0(a) };
    },
    htmlBuilder: (r, e) => {
      var t = l0(r.body, e.withPhantom(), !1);
      return w.makeFragment(t);
    },
    mathmlBuilder: (r, e) => {
      var t = k0(r.body, e);
  ...
  E({
    ...
    htmlBuilder: (r, e) => {
      var t = w.makeSpan([], [P(r.body, e.withPhantom())]);
  ...
  E({
    ...
    htmlBuilder: (r, e) => {
      var t = w.makeSpan(['inner'], [P(r.body, e.withPhantom())]),
        a = w.makeSpan(['fix'], []);
  ...
  E({
    ...
    mathmlBuilder(r, e) {
      var t = t0(r.width, e),
        a = t0(r.height, e),
        n = r.shift ? t0(r.shift, e) : 0,
        i = (e.color && e.getColor()) || 'black',
        l = new M.MathNode('mspace');
  ...
  function zi(r, e, t) {
    for (
      var a = l0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, i = 0;
      i < a.length;
      i++
    ) {
  ...
  E({
    ...
    handler: (r, e) => {
      ...
      return { type: 'sizing', mode: n.mode, size: En.indexOf(a) + 1, body: i };
    },
    htmlBuilder: q1,
    mathmlBuilder: (r, e) => {
      var t = e.havingSize(r.size),
  ...
  E({
    ...
    handler: (r, e, t) => {
      ...
      var v = e[0];
      return { type: 'smash', mode: a.mode, body: v, smashHeight: n, smashDepth: i };
    },
    htmlBuilder: (r, e) => {
      var t = w.makeSpan([], [P(r.body, e)]);
  ...
  E({
    ...
    htmlBuilder(r, e) {
      ...
      var l = n + i / 4,
        ...
        { span: h, ruleWidth: m, advanceWidth: v } = X0.sqrtImage(u, e),
        g = h.height - m;
      g > t.height + t.depth + l && (l = (l + g - t.height - t.depth) / 2);
      var b = h.height - t.height - l - m;
      t.style.paddingLeft = z(v);
      var x = w.makeVList(
        {
          positionType: 'firstBaseline',
          children: [
      ...
      if (r.index) {
        var k = e.havingStyle(O.SCRIPTSCRIPT),
          A = P(r.index, k, e),
          ...
          R = w.makeSpan(['root'], [B]);
        return w.makeSpan(['mord', 'sqrt'], [R, x], e);
      } else return w.makeSpan(['mord', 'sqrt'], [x], e);
    },
    mathmlBuilder(r, e) {
      var { body: t, index: a } = r;
      return a
        ? new M.MathNode('mroot', [V(t, e), V(a, e)])
        : new M.MathNode('msqrt', [V(t, e)]);
    },
  });
  var Bn = {
    display: O.DISPLAY,
  ...
  E({
    ...
    mathmlBuilder(r, e) {
      var t = Bn[r.style],
        ...
        u = l[r.style];
      return (
        i.setAttribute('scriptlevel', u[0]), i.setAttribute('displaystyle', u[1]), i
      );
    },
  });
  var H1 = function (e, t) {
    ...
    if (a)
      if (a.type === 'op') {
        var n =
          a.limits && (t.style.size === O.DISPLAY.size || a.alwaysHandleSupSub);
        return n ? _e : null;
      } else if (a.type === 'operatorname') {
        var i =
          a.alwaysHandleSupSub && (t.style.size === O.DISPLAY.size || a.limits);
        return i ? Ti : null;
      } else {
        if (a.type === 'accent') return $.isCharacterBox(a.base) ? aa : null;
        if (a.type === 'horizBrace') {
          var l = !e.sub;
          return l === a.isOver ? Si : null;
        } else return null;
      }
    else return null;
  };
  ke({
    ...
    htmlBuilder(r, e) {
      ...
      if (h) {
        ...
        (l instanceof w0 || q) && (R = z(-l.italic));
      }
      var j;
      if (u && h) {
        (v = Math.max(v, A, u.depth + 0.25 * m.xHeight)), (g = Math.max(g, m.sub2));
        var I = m.defaultRuleThickness,
          F = 4 * I;
        if (v - u.depth - (h.height - g) < F) {
          g = F - (v - u.depth) + h.height;
          var L = 0.8 * m.xHeight - (v - u.depth);
          L > 0 && ((v += L), (g -= L));
        }
        var Z = [
          { type: 'elem', elem: h, shift: g, marginRight: B, marginLeft: R },
          { type: 'elem', elem: u, shift: -v, marginRight: B },
        ];
        j = w.makeVList({ positionType: 'individualShift', children: Z }, e);
      } else if (h) {
        g = Math.max(g, m.sub1, h.height - 0.8 * m.xHeight);
        var U = [{ type: 'elem', elem: h, marginLeft: R, marginRight: B }];
        j = w.makeVList({ positionType: 'shift', positionData: g, children: U }, e);
      } else if (u)
        (v = Math.max(v, A, u.depth + 0.25 * m.xHeight)),
          (j = w.makeVList(
            {
              positionType: 'shift',
              positionData: -v,
      ...
      var L0 = Fr(l, 'right') || 'mord';
      return w.makeSpan([L0], [l, w.makeSpan(['msupsub'], [j])], e);
    },
    mathmlBuilder(r, e) {
      var t = !1,
        a,
      ...
      var i = [V(r.base, e)];
      r.sub && i.push(V(r.sub, e)), r.sup && i.push(V(r.sup, e));
      var l;
      if (t) l = a ? 'mover' : 'munder';
      else if (r.sub)
        if (r.sup) {
          var m = r.base;
          (m && m.type === 'op' && m.limits && e.style === O.DISPLAY) ||
          (m &&
            m.type === 'operatorname' &&
            m.alwaysHandleSupSub &&
            (e.style === O.DISPLAY || m.limits))
            ? (l = 'munderover')
            : (l = 'msubsup');
        } else {
          var h = r.base;
        ...
        (u &&
          u.type === 'op' &&
          u.limits &&
          (e.style === O.DISPLAY || u.alwaysHandleSupSub)) ||
        (u &&
          u.type === 'operatorname' &&
          u.alwaysHandleSupSub &&
          (u.limits || e.style === O.DISPLAY))
          ? (l = 'mover')
          : (l = 'msup');
      }
  ...
  ke({
    ...
    mathmlBuilder(r, e) {
      var t = new M.MathNode('mo', [E0(r.text, r.mode)]);
      if (r.family === 'bin') {
        var a = ta(r, e);
  ...
  var Ci = { mi: 'italic', mn: 'normal', mtext: 'normal' };
  ke({
    type: 'mathord',
    htmlBuilder(r, e) {
    ...
    mathmlBuilder(r, e) {
      var t = new M.MathNode('mi', [E0(r.text, r.mode, e)]),
        a = ta(r, e) || 'italic';
      return a !== Ci[t.type] && t.setAttribute('mathvariant', a), t;
    },
  });
  ke({
    type: 'textord',
    ...
    mathmlBuilder(r, e) {
      ...
      return (
        ...
        a !== Ci[n.type] && n.setAttribute('mathvariant', a),
        n
      );
    },
  });
  ...
  ke({
    type: 'spacing',
    htmlBuilder(r, e) {
      if (qr.hasOwnProperty(r.text)) {
        var t = qr[r.text].className || '';
        if (r.mode === 'text') {
          var a = w.makeOrd(r, e, 'textord');
          return a.classes.push(t), a;
        } else return w.makeSpan(['mspace', t], [w.mathsym(r.text, r.mode, e)], e);
      } else {
        if (_r.hasOwnProperty(r.text))
          return w.makeSpan(['mspace', _r[r.text]], [], e);
    ...
    mathmlBuilder(r, e) {
      var t;
      if (qr.hasOwnProperty(r.text))
        t = new M.MathNode('mtext', [new M.TextNode('\xA0')]);
      else {
        if (_r.hasOwnProperty(r.text)) return new M.MathNode('mspace');
        throw new T('Unknown type of space "' + r.text + '"');
      }
      return t;
    },
  ...
  ke({
    ...
    mathmlBuilder(r, e) {
      var t = new M.MathNode('mtable', [
        new M.MathNode('mtr', [
          Dn(),
          new M.MathNode('mtd', [oe(r.body, e)]),
          Dn(),
          new M.MathNode('mtd', [oe(r.tag, e)]),
        ]),
      ]);
  ...
  var $n = {
    ...
    I1 = { '\\textit': 'textit', '\\textup': 'textup' },
    On = (r, e) => {
      var t = r.font;
      if (t) {
        if ($n[t]) return e.withTextFontFamily($n[t]);
        if (Nn[t]) return e.withTextFontWeight(Nn[t]);
        if (t === '\\emph')
          return e.fontShape === 'textit'
            ? e.withTextFontShape('textup')
            : e.withTextFontShape('textit');
      } else return e;
      return e.withTextFontShape(I1[t]);
    };
  E({
    type: 'text',
    names: [
    ...
    handler(r, e) {
      var { parser: t, funcName: a } = r,
        n = e[0];
      return { type: 'text', mode: t.mode, body: n0(n), font: a };
    },
    htmlBuilder(r, e) {
      var t = On(r, e),
        a = l0(r.body, t, !0);
  ...
  E({
    ...
    mathmlBuilder(r, e) {
      var t = new M.MathNode('mo', [new M.TextNode('\u203E')]);
      t.setAttribute('stretchy', 'true');
      var a = new M.MathNode('munder', [V(r.body, e), t]);
      return a.setAttribute('accentunder', 'true'), a;
    },
  });
  E({
    ...
    mathmlBuilder(r, e) {
      return new M.MathNode('mpadded', [V(r.body, e)], ['vcenter']);
    },
  });
  E({
    type: 'verb',
    ...
    htmlBuilder(r, e) {
      for (
        var t = Rn(r), a = [], n = e.havingStyle(e.style.text()), i = 0;
        i < t.length;
        i++
      ) {
        var l = t[i];
        l === '~' && (l = '\\textasciitilde'),
          a.push(
            w.makeSymbol(l, 'Typewriter-Regular', r.mode, n, ['mord', 'texttt'])
          );
      }
      return w.makeSpan(
    ...
    Xt = class {
      constructor(e, t) {
        (this.input = void 0),
          ...
          (this.input = e),
          (this.settings = t),
          (this.tokenRegex = new RegExp(V1, 'g')),
          (this.catcodes = { '%': 14, '~': 13 });
      }
      setCatcode(e, t) {
        this.catcodes[e] = t;
      ...
      lex() {
        ...
        if (t === e.length) return new C0('EOF', new A0(this, t, t));
        var a = this.tokenRegex.exec(e);
        if (a === null || a.index !== t)
          throw new T(
            "Unexpected character: '" + e[t] + "'",
            new C0(e[t], new A0(this, t, t + 1))
          );
        var n = a[6] || a[3] || (a[2] ? '\\ ' : ' ');
...
`,
        ...
        return new C0(n, new A0(this, t, this.tokenRegex.lastIndex));
      }
    },
    Yr = class {
      constructor(e, t) {
  ...
  d('\\char', function (r) {
    ...
    if (t) {
      if (((a = _n[e.text]), a == null || a >= t))
        throw new T('Invalid base-' + t + ' digit ' + e.text);
      for (var n; (n = _n[r.future().text]) != null && n < t; )
        (a *= t), (a += n), r.popToken();
    }
    return '\\@char{' + a + '}';
  });
  var ca = (r, e, t) => {
    ...
    if (((a = r.consumeArg().tokens), a.length === 1 && a[0].text === '[')) {
      for (var u = '', h = r.expandNextToken(); h.text !== ']' && h.text !== 'EOF'; )
        (u += h.text), (h = r.expandNextToken());
      if (!u.match(/^\s*[0-9]+\s*$/))
        throw new T('Invalid number of arguments: ' + u);
      (l = parseInt(u)), (a = r.consumeArg().tokens);
    }
    return r.macros.set(n, { tokens: a, numArgs: l }), '';
  };
  d('\\newcommand', (r) => ca(r, !1, !0));
  d('\\renewcommand', (r) => ca(r, !0, !1));
  d('\\providecommand', (r) => ca(r, !0, !0));
  d('\\message', (r) => {
  ...
  d('\\show', (r) => {
    var e = r.popToken(),
      t = e.text;
    return console.log(e, r.macros.get(t), se[t], K.math[t], K.text[t]), '';
  });
  d('\\bgroup', '{');
  d('\\egroup', '}');
  d('~', '\\nobreakspace');
  ...
  d('\\aa', '\\r a');
  d('\\AA', '\\r A');
  d('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xA9}');
  d('\\copyright', '\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}');
  d('\\textregistered', '\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xAE}');
  d('\u212C', '\\mathscr{B}');
  d('\u2130', '\\mathscr{E}');
  d('\u2131', '\\mathscr{F}');
  d('\u210B', '\\mathscr{H}');
  ...
  d('\\dots', function (r) {
    ...
    return (
      t in qn
        ? (e = qn[t])
        : (t.slice(0, 4) === '\\not' ||
            (t in K.math && $.contains(['bin', 'rel'], K.math[t].group))) &&
          (e = '\\dotsb'),
      e
    );
  });
  ...
  d('\\dotso', function (r) {
    var e = r.future().text;
    return e in da ? '\\ldots\\,' : '\\ldots';
  });
  d('\\dotsc', function (r) {
    var e = r.future().text;
    return e in da && e !== ',' ? '\\ldots\\,' : '\\ldots';
  });
  d('\\cdots', function (r) {
    var e = r.future().text;
    return e in da ? '\\@cdots\\,' : '\\@cdots';
  });
  d('\\dotsb', '\\cdots');
  d('\\dotsm', '\\cdots');
  d('\\dotsi', '\\!\\cdots');
  ...
  var Bi = z(
    _0['Main-Regular']['T'.charCodeAt(0)][1] -
      0.7 * _0['Main-Regular']['A'.charCodeAt(0)][1]
  );
  d(
    '\\LaTeX',
    '\\textrm{\\html@mathml{' +
      ('L\\kern-.36em\\raisebox{' + Bi + '}{\\scriptstyle A}') +
      '\\kern-.15em\\TeX}{LaTeX}}'
  );
  d(
    '\\KaTeX',
    '\\textrm{\\html@mathml{' +
      ('K\\kern-.17em\\raisebox{' + Bi + '}{\\scriptstyle A}') +
      '\\kern-.15em\\TeX}{KaTeX}}'
  );
    ...
    Xr = class {
      constructor(e, t, a) {
        (this.settings = void 0),
          ...
          this.feed(e),
          (this.macros = new Yr(G1, t.macros)),
          (this.mode = a),
          (this.stack = []);
      }
      feed(e) {
        this.lexer = new Xt(e, this.settings);
      }
      switchMode(e) {
        this.mode = e;
      }
      ...
      scanArgument(e) {
        ...
        return (
          this.pushToken(new C0('EOF', a.loc)), this.pushTokens(n), t.range(a, '')
        );
      }
      consumeSpaces() {
        for (;;) {
      ...
      countExpansion(e) {
        if (
          ((this.expansionCount += e), this.expansionCount > this.settings.maxExpand)
        )
          throw new T(
      ...
      expandOnce(e) {
        ...
        if (n.numArgs) {
          ...
          for (var u = i.length - 1; u >= 0; --u) {
            ...
            if (h.text === '#') {
              if (u === 0)
                throw new T('Incomplete placeholder at end of macro body', h);
              if (((h = i[--u]), h.text === '#')) i.splice(u + 1, 1);
              else if (/^[1-9]$/.test(h.text)) i.splice(u, 2, ...l[+h.text - 1]);
              else throw new T('Not a valid argument number', h);
            }
          }
        }
        ...
        if (typeof n == 'string') {
          ...
          if (n.indexOf('#') !== -1)
            for (var l = n.replace(/##/g, ''); l.indexOf('#' + (i + 1)) !== -1; )
              ++i;
          for (
            var u = new Xt(n, this.settings), h = [], m = u.lex();
            m.text !== 'EOF';

          )
            h.push(m), (m = u.lex());
          h.reverse();
          var v = { tokens: h, numArgs: i };
          return v;
        }
        return n;
      }
      ...
      isExpandable(e) {
        ...
        return t != null
          ...
          : se.hasOwnProperty(e) && !se[e].primitive;
      }
    },
    Hn = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
    Lt = Object.freeze({
      '\u208A': '+',
      '\u208B': '-',
      '\u208C': '=',
    ...
    Zt = class r {
      constructor(e, t) {
        (this.mode = void 0),
          ...
          (this.mode = 'math'),
          (this.gullet = new Xr(e, t, this.mode)),
          (this.settings = t),
      ...
      handleInfixNodes(e) {
        ...
        if (t !== -1 && a) {
          ...
          return (
            a === '\\\\abovefrac'
              ? (m = this.callFunction(a, [i, e[t], l], []))
              : (m = this.callFunction(a, [i, l], [])),
            [m]
          );
        } else return e;
      }
      ...
      parseAtom(e) {
        ...
        for (var a, n; ; ) {
          ...
          if (i.text === '\\limits' || i.text === '\\nolimits') {
            ...
            var m = Hn.test(i.text),
              v = [];
            for (v.push(new C0(Lt[i.text])), this.consume(); ; ) {
              var g = this.fetch().text;
              if (!Lt[g] || Hn.test(g) !== m) break;
              v.unshift(new C0(Lt[g])), this.consume();
            }
      ...
      parseArguments(e, t) {
        ...
        for (var n = [], i = [], l = 0; l < a; l++) {
          var u = t.argTypes && t.argTypes[l],
            h = l < t.numOptionalArgs;
          ((t.primitive && u == null) ||
            (t.type === 'sqrt' && l === 1 && i[0] == null)) &&
            (u = 'primitive');
          var m = this.parseGroupOfType("argument to '" + e + "'", u, h);
          if (h) i.push(m);
      ...
      parseGroupOfType(e, t, a) {
        switch (t) {
          ...
          case 'primitive': {
            ...
            if (l == null) throw new T('Expected group as ' + e, this.fetch());
            return l;
          }
          case 'original':
          case null:
      ...
      parseSizeGroup(e) {
        ...
        if (!jn(i)) throw new T("Invalid unit: '" + i.unit + "'", t);
      ...
      parseSymbol() {
        ...
        if (K[this.mode][t]) {
          ...
          var u = K[this.mode][t].group,
            h = A0.range(e),
            m;
          if (qs.hasOwnProperty(u)) {
            var v = u;
            m = { type: 'atom', mode: this.mode, family: v, loc: h, text: t };
          } else m = { type: u, mode: this.mode, loc: h, text: t };
          l = m;
          ...
          this.settings.strict &&
            ...
            (l = { type: 'textord', mode: 'text', loc: A0.range(e), text: t });
        else return null;
        if ((this.consume(), i))
          for (var g = 0; g < i[0].length; g++) {
            var b = i[0][g];
            if (!Hr[b]) throw new T("Unknown accent ' " + b + "'", e);
            var x = Hr[b][this.mode] || Hr[b].text;
            if (!x)
              throw new T(
  ...
  var K1 = function (e, t) {
    ...
    Oi = function (e, t, a) {
      ...
      var n = w.makeSpan(['katex-error'], [new w0(t)]);
      return (
  ...
  var X1 = function (e, t, a) {
      for (var n = a, i = 0, l = e.length; n < t.length; ) {
        var u = t[n];
        if (i <= 0 && t.slice(n, n + l) === e) return n;
        u === '\\' ? n++ : u === '{' ? i++ : u === '}' && i--, n++;
      }
      return -1;
    },
    ...
    Q1 = function (e, t) {
      for (
        var a,
          n = [],
          i = new RegExp('(' + t.map((m) => Z1(m.left)).join('|') + ')');
        (a = e.search(i)), a !== -1;

      ) {
        a > 0 && (n.push({ type: 'text', data: e.slice(0, a) }), (e = e.slice(a)));
        var l = t.findIndex((m) => e.startsWith(m.left));
        if (((a = X1(t[l].right, e, t[l].left.length)), a === -1)) break;
        var u = e.slice(0, a + t[l].right.length),
          h = J1.test(u) ? u : e.slice(t[l].left.length, a);
        n.push({ type: 'math', data: h, rawData: u, display: t[l].display }),
          (e = e.slice(a + t[l].right.length));
      }
      return e !== '' && n.push({ type: 'text', data: e }), n;
    },
    el = function (e, t) {
      var a = Q1(e, t.delimiters);
      if (a.length === 1 && a[0].type === 'text') return null;
      for (var n = document.createDocumentFragment(), i = 0; i < a.length; i++)
        if (a[i].type === 'text') n.appendChild(document.createTextNode(a[i].data));
        else {
          var l = document.createElement('span'),
            u = a[i].data;
          t.displayMode = a[i].display;
          try {
            t.preProcess && (u = t.preProcess(u)), pa.render(u, l, t);
          } catch (h) {
            if (!(h instanceof pa.ParseError)) throw h;
            t.errorCallback(
              'KaTeX auto-render: Failed to parse `' + a[i].data + '` with ',
              h
            ),
              n.appendChild(document.createTextNode(a[i].rawData));
            continue;
          }
          n.appendChild(l);
        }
    ...
    tl = function r(e, t) {
      for (var a = 0; a < e.childNodes.length; a++) {
        ...
        if (n.nodeType === 3) {
          for (
            var i = n.textContent, l = n.nextSibling, u = 0;
            l && l.nodeType === Node.TEXT_NODE;

          )
            (i += l.textContent), (l = l.nextSibling), u++;
          var h = el(i, t);
          if (h) {
            for (var m = 0; m < u; m++) n.nextSibling.remove();
            (a += h.childNodes.length - 1), e.replaceChild(h, n);
          } else a += u;
        } else
          n.nodeType === 1 &&
            (function () {
              var v = ' ' + n.className + ' ',
                g =
                  t.ignoredTags.indexOf(n.nodeName.toLowerCase()) === -1 &&
                  t.ignoredClasses.every((b) => v.indexOf(' ' + b + ' ') === -1);
              g && r(n, t);
            })();
      }
    },
    Ri = function (e, t) {
      ...
      (a.delimiters = a.delimiters || [
        ...
        (a.ignoredClasses = a.ignoredClasses || []),
        (a.errorCallback = a.errorCallback || console.error),
        (a.macros = a.macros || {}),
        tl(e, a);
    };
  function rl(r, e) {
    return r.reduce(
      ([t, a], n) => (e(n) ? [[...t, n], a] : [t, [...a, n]]),
      [[], []]
    );
  }
  window.addEventListener('load', (r) => {
    ...
    let e = (l) => {
        for (; l != null; )
          l.nodeName == 'DETAILS' && (l.open = !0), (l = l.parentNode);
      },
      t = (l) => {
        if (l.target.tagName === 'A') return;
        let h = l.target.closest('span[data-target]').getAttribute('data-target'),
          m = document.querySelector(h);
        e(m), (window.location = h);
      };
    [...document.querySelectorAll("[data-target^='#']")].forEach((l) =>
      l.addEventListener('click', t)
    );
    let a = document.querySelector('ninja-keys'),
      i = `${document
        .querySelector('html')
        .getAttribute('data-base-url')}forest.json`;
    fetch(i)
      .then((l) => l.json())
      .then((l) => {
        let u = [],
        ...
        let v = (k) => (k.tags ? k.tags.includes('top') : !1),
          g = (k, A, C) => {
            let R = `${
              k.taxon
                ? k.title
            ...
            u.push({
              ...
              icon: C,
              handler: () => {
                window.location.href = k.route;
              },
            });
          },
          [b, x] = rl(l, v);
        b.forEach((k) => g(k, 'Top Trees', m)),
          x.forEach((k) => g(k, 'All Trees', null)),
          (a.data = u);
      });
  });
})();
