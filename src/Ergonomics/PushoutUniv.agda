...
Cocone←universal-is-equiv {f = f} {g = g} Q ⦃ p-u ⦄ ⦃ q-u ⦄ = is-equiv←qinv qinv where
  ...
  qinv : quasi-inv (Cocone←universal Q)
  qinv .fst (mk-cocone p q filler)
    = mk-coconeU (Univ← auto! p) (Univ← auto! q)
              λ x → happly (Univ≃.ε auto! p) _ ∙ filler x ∙ sym (happly (Univ≃.ε auto! q) _)
  qinv .snd .fst a = CoconeU-path→ _ a (Univ≃.η p-u _) (Univ≃.η q-u _)
  ...
  qinv .snd .snd cc = Cocone-path→ _ cc (Univ≃.ε auto! _) (Univ≃.ε auto! _)
